package
{
   ...
   public class _refactor_bisecur__1_APP_components_stateImages_SectionalDoorStateImageWatcherSetupUtil implements IWatcherSetupUtil2
   {
       
      
      public function _refactor_bisecur__1_APP_components_stateImages_SectionalDoorStateImageWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         SectionalDoorStateImage.watcherSetupUtil = new _refactor_bisecur__1_APP_components_stateImages_SectionalDoorStateImageWatcherSetupUtil();
      }
