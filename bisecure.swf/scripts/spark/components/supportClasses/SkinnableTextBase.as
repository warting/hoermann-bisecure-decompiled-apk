package spark.components.supportClasses
{
   ...
   public class SkinnableTextBase extends SkinnableComponent implements IFocusManagerComponent, IIMESupport, ISoftKeyboardHintClient
   {
      ...
      private function textDisplay_changeHandler(param1:Event) : void
      {
         ...
         if(this.prompt != null && this.prompt != "" && skin && skin.currentState)
         {
            if(skin.currentState.indexOf("WithPrompt") != -1 && this.text.length != 0 || skin.currentState.indexOf("WithPrompt") == -1 && this.text.length == 0)
            {
               invalidateSkinState();
            }
         }
