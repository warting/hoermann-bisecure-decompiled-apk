package spark.components
{
   ...
   public class DataGroup extends GroupBase implements IItemRendererOwner
   {
      ...
      mx_internal function itemRemoved(param1:Object, param2:int) : void
      {
         ...
         {
            _loc4_ = -1;
            _loc5_ = this.virtualRendererIndices.length;
            _loc6_ = 0;
            while(_loc6_ < _loc5_)
            {
               _loc7_ = this.virtualRendererIndices[_loc6_];
               if(_loc7_ == param2)
               {
                  _loc4_ = _loc6_;
               }
               ...
               {
                  this.virtualRendererIndices[_loc6_] = _loc7_ - 1;
               }
               _loc6_++;
            }
            if(_loc4_ != -1)
            {
               this.virtualRendererIndices.splice(_loc4_,1);
            }
         }
         ...
         if(_loc3_)
         {
            ...
            _loc8_ = _loc3_ as DisplayObject;
            if(_loc8_)
            {
               super.removeChild(_loc8_);
            }
         }
         this.invalidateSize();
         invalidateDisplayList();
