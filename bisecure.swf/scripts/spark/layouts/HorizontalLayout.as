package spark.layouts
{
   ...
   public class HorizontalLayout extends LayoutBase
   {
      ...
      public function set padding(param1:Number) : void
      {
         ...
         this.paddingBottom = this._padding;
         this.paddingLeft = this._padding;
         this.paddingRight = this._padding;
         this.paddingTop = this._padding;
         this.invalidateTargetSizeAndDisplayList();
      }
      ...
      private function getElementWidth(param1:ILayoutElement, param2:Number, param3:SizesAndLimit#49) : void
      {
      ...
      private function getElementHeight(param1:ILayoutElement, param2:Boolean, param3:SizesAndLimit#49) : void
      {
      ...
      private function measureReal(param1:GroupBase) : void
      {
         ...
         var _loc2_:SizesAndLimit = new SizesAndLimit#49();
