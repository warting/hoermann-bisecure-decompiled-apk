package spark.skins.ios7.supportClasses
{
   ...
   public class CalloutArrow extends UIComponent
   {
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         var _loc19_:Vector.<int> = new Vector.<int>(4,true);
         var _loc20_:Vector.<Number> = new Vector.<Number>(10,true);
         _loc19_[0] = GraphicsPathCommand.MOVE_TO;
         _loc19_[1] = GraphicsPathCommand.LINE_TO;
         _loc19_[2] = GraphicsPathCommand.CURVE_TO;
         _loc19_[3] = GraphicsPathCommand.LINE_TO;
         if(_loc4_ == ArrowDirection.LEFT || _loc4_ == ArrowDirection.RIGHT)
         {
            ...
            _loc20_[0] = _loc9_;
            _loc20_[1] = _loc10_;
            _loc20_[2] = _loc11_ + this.arrowTipCurveAnchorDistance;
            _loc20_[3] = _loc12_ - this.arrowTipCurveAnchorDistance;
            if(_loc4_ == ArrowDirection.LEFT)
            {
               _loc20_[4] = _loc11_ - this.arrowTipCurveAnchorDistance * 2;
            }
            else
            {
               _loc20_[4] = _loc11_ + this.arrowTipCurveAnchorDistance * 2;
            ...
            _loc20_[5] = _loc12_;
            _loc20_[6] = _loc11_ + this.arrowTipCurveAnchorDistance;
            _loc20_[7] = _loc12_ + this.arrowTipCurveAnchorDistance;
            _loc20_[8] = _loc13_;
            _loc20_[9] = _loc14_;
         }
         else
         {
            ...
            if(_loc3_.arrowDirection == ArrowDirection.UP)
            {
               _loc20_[5] = _loc12_ - this.arrowTipCurveAnchorDistance * 2;
            }
            else
            {
               _loc20_[5] = _loc12_ + this.arrowTipCurveAnchorDistance * 2;
