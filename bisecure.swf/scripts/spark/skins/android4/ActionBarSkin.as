package spark.skins.android4
{
   ...
   public class ActionBarSkin extends MobileSkin
   {
      ...
      public var titleDisplay:TitleDisplayComponent#761;
      ...
      override protected function createChildren() : void
      {
         ...
         this.titleDisplay = new TitleDisplayComponent#761();
...
class TitleDisplayComponent#761 extends UIComponent implements IDisplayText
{
   ...
   function TitleDisplayComponent#761()
   {
      super();
      this.title = "";
   }
