package spark.skins.mobile
{
   ...
   public class CalloutViewNavigatorSkin extends ViewNavigatorSkin
   {
      ...
      public function CalloutViewNavigatorSkin()
      {
         ...
         switch(applicationDPI)
         {
            case DPIClassification.DPI_640:
               this.contentBackgroundClass = spark.skins.mobile640.assets.CalloutContentBackground;
               this.contentCornerRadius = 28;
               this.gap = 48;
               break;
            case DPIClassification.DPI_480:
               this.contentBackgroundClass = spark.skins.mobile480.assets.CalloutContentBackground;
               this.contentCornerRadius = 14;
               this.gap = 24;
               break;
            case DPIClassification.DPI_320:
               this.contentBackgroundClass = spark.skins.mobile320.assets.CalloutContentBackground;
               this.contentCornerRadius = 10;
               this.gap = 16;
               break;
            case DPIClassification.DPI_240:
               this.contentBackgroundClass = spark.skins.mobile240.assets.CalloutContentBackground;
            ...
            case DPIClassification.DPI_240:
               ...
               break;
            default:
               this.contentBackgroundClass = spark.skins.mobile160.assets.CalloutContentBackground;
      ...
      override protected function createChildren() : void
      {
         ...
         this.contentBackgroundGraphic = new this.contentBackgroundClass() as SpriteVisualElement;
      ...
      override protected function layoutContents(param1:Number, param2:Number) : void
      {
         ...
         if(contentGroup.includeInLayout)
         {
            ...
            setElementSize(this.contentBackgroundGraphic,param1,_loc4_);
            setElementPosition(this.contentBackgroundGraphic,0,_loc3_ + this.gap);
         }
      ...
      override protected function drawBackground(param1:Number, param2:Number) : void
      {
         ...
         graphics.drawRoundRect(this.contentBackgroundGraphic.getLayoutBoundsX(),this.contentBackgroundGraphic.getLayoutBoundsY(),_loc5_,_loc6_,_loc3_,_loc3_);
         graphics.endFill();
         if(this.contentMask)
         {
         ...
         this.contentBackgroundGraphic.alpha = _loc4_;
      }
   }
}
