package spark.skins.mobile
{
   ...
   import spark.layouts.ViewMenuLayout;
   ...
   public class ViewMenuSkin extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      private var _992534608contentGroupLayout:ViewMenuLayout;
      
      private var _803733169dividerStroke:SolidColorStroke;
      ...
      public function ViewMenuSkin()
      {
         ...
         {
            watcherSetupUtilClass = getDefinitionByName("_spark_skins_mobile_ViewMenuSkinWatcherSetupUtil");
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         this.dividerStroke.weight = _loc3_;
         this.background.top = _loc3_;
         this.contentGroup.top = _loc3_ + _loc4_;
         this.contentGroup.bottom = _loc4_;
         this.contentGroupLayout.horizontalGap = _loc4_;
         this.contentGroupLayout.verticalGap = _loc4_;
      }
      ...
      private function _ViewMenuSkin_Group1_i() : Group
      {
         ...
         _loc1_.left = 0;
         _loc1_.right = 0;
         _loc1_.mxmlContent = [this._ViewMenuSkin_Rect1_c(),this._ViewMenuSkin_Rect2_i(),this._ViewMenuSkin_Group2_i()];
      ...
      private function _ViewMenuSkin_Rect1_c() : Rect
      {
         ...
         _loc1_.top = 0;
         _loc1_.height = 0;
         _loc1_.stroke = this._ViewMenuSkin_SolidColorStroke1_i();
         _loc1_.initialized(this,null);
         return _loc1_;
      }
      
      private function _ViewMenuSkin_SolidColorStroke1_i() : SolidColorStroke
      {
         var _loc1_:SolidColorStroke = new SolidColorStroke();
         _loc1_.weight = 1;
         _loc1_.color = 0;
         _loc1_.alpha = 0.9;
         this.dividerStroke = _loc1_;
         BindingManager.executeBindings(this,"dividerStroke",this.dividerStroke);
         return _loc1_;
      }
      
      private function _ViewMenuSkin_Rect2_i() : Rect
      {
         var _loc1_:Rect = new Rect();
         _loc1_.left = 0;
         _loc1_.right = 0;
      ...
      private function _ViewMenuSkin_Group2_i() : Group
      {
         ...
         _loc1_.minWidth = 0;
         _loc1_.minHeight = 0;
         _loc1_.layout = this._ViewMenuSkin_ViewMenuLayout1_i();
      ...
      private function _ViewMenuSkin_ViewMenuLayout1_i() : ViewMenuLayout
      {
         var _loc1_:ViewMenuLayout = new ViewMenuLayout();
      ...
      [Bindable(event="propertyChange")]
      public function get contentGroupLayout() : ViewMenuLayout
      {
         return this._992534608contentGroupLayout;
      }
      
      public function set contentGroupLayout(param1:ViewMenuLayout) : void
      {
      ...
      [Bindable(event="propertyChange")]
      public function get dividerStroke() : SolidColorStroke
      {
         return this._803733169dividerStroke;
      }
      
      public function set dividerStroke(param1:SolidColorStroke) : void
      {
         var _loc2_:Object = this._803733169dividerStroke;
         if(_loc2_ !== param1)
         {
            this._803733169dividerStroke = param1;
            if(this.hasEventListener("propertyChange"))
            {
               this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this,"dividerStroke",_loc2_,param1));
            }
         }
      }
