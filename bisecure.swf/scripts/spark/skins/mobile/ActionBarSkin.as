package spark.skins.mobile
{
   ...
   public class ActionBarSkin extends MobileSkin
   {
      ...
      public var titleDisplay:TitleDisplayComponent#755;
      ...
      public function ActionBarSkin()
      {
         ...
         switch(applicationDPI)
         {
            case DPIClassification.DPI_640:
               this.borderSize = 2;
               this.layoutShadowHeight = 12;
               this.layoutContentGroupHeight = 172;
               this.layoutTitleGroupHorizontalPadding = 52;
               this.borderClass = spark.skins.mobile640.assets.ActionBarBackground;
               break;
            case DPIClassification.DPI_480:
               this.borderSize = 2;
               this.layoutShadowHeight = 9;
               this.layoutContentGroupHeight = 130;
               this.layoutTitleGroupHorizontalPadding = 40;
               this.borderClass = spark.skins.mobile480.assets.ActionBarBackground;
               break;
            case DPIClassification.DPI_320:
               this.borderSize = 2;
               this.layoutShadowHeight = 6;
               this.layoutContentGroupHeight = 86;
               this.layoutTitleGroupHorizontalPadding = 26;
               this.borderClass = spark.skins.mobile320.assets.ActionBarBackground;
               break;
            case DPIClassification.DPI_240:
               this.borderSize = 1;
               this.layoutShadowHeight = 3;
               this.layoutContentGroupHeight = 65;
               this.layoutTitleGroupHorizontalPadding = 20;
               this.borderClass = spark.skins.mobile240.assets.ActionBarBackground;
               break;
            case DPIClassification.DPI_120:
               this.borderSize = 1;
               this.layoutShadowHeight = 1.5;
               this.layoutContentGroupHeight = 32;
               this.layoutTitleGroupHorizontalPadding = 10;
               this.borderClass = spark.skins.mobile120.assets.ActionBarBackground;
               break;
            default:
               this.borderSize = 1;
               this.layoutShadowHeight = 3;
               ...
               this.borderClass = spark.skins.mobile160.assets.ActionBarBackground;
         }
      }
      ...
      override protected function createChildren() : void
      {
         ...
         this.titleDisplay = new TitleDisplayComponent#755();
      ...
      override protected function layoutContents(param1:Number, param2:Number) : void
      {
         ...
         if(this.border)
         {
            setElementSize(this.border,param1,param2 + this.layoutShadowHeight);
         }
      ...
      override protected function drawBackground(param1:Number, param2:Number) : void
      {
         ...
         var _loc5_:Array = [];
         var _loc6_:Array = [_loc4_,_loc4_];
         colorMatrix.createGradientBox(param1,param2 - this.borderSize * 2,Math.PI / 2,0,0);
         _loc5_[0] = ColorUtil.adjustBrightness2(_loc3_,20);
         _loc5_[1] = _loc3_;
         graphics.beginGradientFill(GradientType.LINEAR,_loc5_,_loc6_,ACTIONBAR_CHROME_COLOR_RATIOS,colorMatrix);
         graphics.drawRect(0,this.borderSize,param1,param2 - this.borderSize * 2);
         graphics.endFill();
      }
   }
}
...
class TitleDisplayComponent#755 extends UIComponent implements IDisplayText
{
   ...
   function TitleDisplayComponent#755()
   {
      super();
      this.title = "";
   }
