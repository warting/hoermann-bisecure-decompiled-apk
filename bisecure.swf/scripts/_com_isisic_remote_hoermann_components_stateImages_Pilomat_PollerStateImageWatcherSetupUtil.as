package
{
   ...
   public class _com_isisic_remote_hoermann_components_stateImages_Pilomat_PollerStateImageWatcherSetupUtil implements IWatcherSetupUtil2
   {
       
      
      public function _com_isisic_remote_hoermann_components_stateImages_Pilomat_PollerStateImageWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         Pilomat_PollerStateImage.watcherSetupUtil = new _com_isisic_remote_hoermann_components_stateImages_Pilomat_PollerStateImageWatcherSetupUtil();
      }
