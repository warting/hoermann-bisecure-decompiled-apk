package
{
   ...
   public class _refactor_bisecur__1_APP_components_stateImages_SwingGateSingleStateImageWatcherSetupUtil implements IWatcherSetupUtil2
   {
       
      
      public function _refactor_bisecur__1_APP_components_stateImages_SwingGateSingleStateImageWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         SwingGateSingleStateImage.watcherSetupUtil = new _refactor_bisecur__1_APP_components_stateImages_SwingGateSingleStateImageWatcherSetupUtil();
      }
