package
{
   ...
   public class _com_isisic_remote_hoermann_components_stateImages_SlidingGateStateImageWatcherSetupUtil implements IWatcherSetupUtil2
   {
       
      
      public function _com_isisic_remote_hoermann_components_stateImages_SlidingGateStateImageWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         SlidingGateStateImage.watcherSetupUtil = new _com_isisic_remote_hoermann_components_stateImages_SlidingGateStateImageWatcherSetupUtil();
      }
