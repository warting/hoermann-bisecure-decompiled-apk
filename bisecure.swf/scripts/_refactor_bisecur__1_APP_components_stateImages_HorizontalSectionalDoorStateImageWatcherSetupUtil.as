package
{
   ...
   public class _refactor_bisecur__1_APP_components_stateImages_HorizontalSectionalDoorStateImageWatcherSetupUtil implements IWatcherSetupUtil2
   {
       
      
      public function _refactor_bisecur__1_APP_components_stateImages_HorizontalSectionalDoorStateImageWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         HorizontalSectionalDoorStateImage.watcherSetupUtil = new _refactor_bisecur__1_APP_components_stateImages_HorizontalSectionalDoorStateImageWatcherSetupUtil();
      }
