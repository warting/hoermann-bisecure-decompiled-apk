package
{
   ...
   public class _spark_skins_mobile_ViewMenuSkinWatcherSetupUtil implements IWatcherSetupUtil2
   {
       
      
      public function _spark_skins_mobile_ViewMenuSkinWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         ViewMenuSkin.watcherSetupUtil = new _spark_skins_mobile_ViewMenuSkinWatcherSetupUtil();
      }
