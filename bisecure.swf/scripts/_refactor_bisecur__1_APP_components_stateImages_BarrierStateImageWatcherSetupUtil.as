package
{
   ...
   public class _refactor_bisecur__1_APP_components_stateImages_BarrierStateImageWatcherSetupUtil implements IWatcherSetupUtil2
   {
       
      
      public function _refactor_bisecur__1_APP_components_stateImages_BarrierStateImageWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         BarrierStateImage.watcherSetupUtil = new _refactor_bisecur__1_APP_components_stateImages_BarrierStateImageWatcherSetupUtil();
      }
