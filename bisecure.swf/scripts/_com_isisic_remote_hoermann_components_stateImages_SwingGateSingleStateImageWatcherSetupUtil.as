package
{
   ...
   public class _com_isisic_remote_hoermann_components_stateImages_SwingGateSingleStateImageWatcherSetupUtil implements IWatcherSetupUtil2
   {
       
      
      public function _com_isisic_remote_hoermann_components_stateImages_SwingGateSingleStateImageWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         SwingGateSingleStateImage.watcherSetupUtil = new _com_isisic_remote_hoermann_components_stateImages_SwingGateSingleStateImageWatcherSetupUtil();
      }
