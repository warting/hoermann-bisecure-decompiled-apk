package
{
   ...
   public class _refactor_bisecur__1_APP_components_stateImages_DoorStateImageWatcherSetupUtil implements IWatcherSetupUtil2
   {
       
      
      public function _refactor_bisecur__1_APP_components_stateImages_DoorStateImageWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         DoorStateImage.watcherSetupUtil = new _refactor_bisecur__1_APP_components_stateImages_DoorStateImageWatcherSetupUtil();
      }
