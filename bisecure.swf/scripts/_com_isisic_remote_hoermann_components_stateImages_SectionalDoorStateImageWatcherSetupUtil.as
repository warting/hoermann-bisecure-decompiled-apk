package
{
   ...
   public class _com_isisic_remote_hoermann_components_stateImages_SectionalDoorStateImageWatcherSetupUtil implements IWatcherSetupUtil2
   {
       
      
      public function _com_isisic_remote_hoermann_components_stateImages_SectionalDoorStateImageWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         SectionalDoorStateImage.watcherSetupUtil = new _com_isisic_remote_hoermann_components_stateImages_SectionalDoorStateImageWatcherSetupUtil();
      }
