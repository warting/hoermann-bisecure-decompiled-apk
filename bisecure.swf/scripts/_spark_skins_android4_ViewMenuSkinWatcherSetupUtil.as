package
{
   ...
   import spark.skins.android4.ViewMenuSkin;
   
   public class _spark_skins_android4_ViewMenuSkinWatcherSetupUtil implements IWatcherSetupUtil2
   {
       
      
      public function _spark_skins_android4_ViewMenuSkinWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         ViewMenuSkin.watcherSetupUtil = new _spark_skins_android4_ViewMenuSkinWatcherSetupUtil();
      }
