package refactor.bisecur._1_APP.views.notifications
{
   ...
   import com.isisic.remote.hoermann.views.notifications.NotificationRenderer;
   ...
   public class NotificationCenter extends View implements IBindingClient
   {
      ...
      public function NotificationCenter()
      {
         ...
         {
            watcherSetupUtilClass = getDefinitionByName("_refactor_bisecur__1_APP_views_notifications_NotificationCenterWatcherSetupUtil");
      ...
      private function onInit() : void
      {
         ...
         NotificationLoader.instance.writeCache();
      ...
      private function _NotificationCenter_bindingsSetup() : Array
      {
         ...
         {
            return AppCache.sharedCache.loggedIn;
