package refactor.bisecur._1_APP.views.onlineHelp
{
   ...
   public class HelpScreen extends View implements IBindingClient
   {
      ...
      public function HelpScreen()
      {
         ...
         {
            watcherSetupUtilClass = getDefinitionByName("_refactor_bisecur__1_APP_views_onlineHelp_HelpScreenWatcherSetupUtil");
