package refactor.bisecur._1_APP.views.manageUsers.renderer
{
   ...
   public class UserRenderer extends RoundetTableItemRenderer implements IBindingClient
   {
      ...
      public function UserRenderer()
      {
         ...
         {
            watcherSetupUtilClass = getDefinitionByName("_refactor_bisecur__1_APP_views_manageUsers_renderer_UserRendererWatcherSetupUtil");
      ...
      {
         if(data != null && data.rendererState.editMode)
         {
      ...
      {
         super.data = param1;
         if(!(data != null && data is UserRendererItem))
         {
            Log.error("[UserRenderer] can not apply data " + param1 + " is not a UserRendererItem");
         }
      }
      ...
      private function _UserRenderer_bindingsSetup() : Array
      {
         ...
         {
            return !!data.user.isAdmin?Number(0):Number(1);
         },null,"btnEdit.alpha");
         result[8] = new Binding(this,function():Boolean
         {
            return data.rendererState.editMode;
