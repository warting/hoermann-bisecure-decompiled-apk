package refactor.bisecur._1_APP.components.stateImages
{
   ...
   public class SwingGateSingleStateImage extends StateImageBase implements IBindingClient
   {
      ...
      public function SwingGateSingleStateImage()
      {
         ...
         {
            watcherSetupUtilClass = getDefinitionByName("_refactor_bisecur__1_APP_components_stateImages_SwingGateSingleStateImageWatcherSetupUtil");
         ...
         if(param1.showState && param1.requestable)
         {
            switch(param1.actorState)
            {
               ...
               default:
                  ...
                  Log.error("[SwingGateSingleStateImage] ActorState \'" + param1.actorState + "\' is not available for SwingGateSingleStateImage!");
            }
         }
