...
{
   import com.isisic.remote.hoermann.assets.images.devices.barrier.FXG_BAR_StateClosed;
   import com.isisic.remote.hoermann.assets.images.devices.barrier.FXG_BAR_StateNotClosed;
   import com.isisic.remote.hoermann.assets.images.devices.barrier.FXG_BAR_StateOpened;
   ...
   public class BarrierStateImage extends StateImageBase implements IBindingClient
   {
      ...
      public function BarrierStateImage()
      {
         ...
         var bindings:Array = this._BarrierStateImage_bindingsSetup();
         var watchers:Array = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_refactor_bisecur__1_APP_components_stateImages_BarrierStateImageWatcherSetupUtil");
         ...
         {
            return BarrierStateImage[param1];
         },bindings,watchers);
         mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
         mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
         this.mxmlContentFactory = new DeferredInstanceFromFunction(this._BarrierStateImage_Array1_c);
         var i:uint = 0;
      ...
      {
         BarrierStateImage._watcherSetupUtil = param1;
      }
         ...
         if(param1.showState && param1.requestable)
         {
            switch(param1.actorState)
            {
               case ActorState.OPEN:
                  this.setStateImage(new FXG_BAR_StateOpened(),param1.additionalIcon);
                  break;
               case ActorState.CLOSED:
                  this.setStateImage(new FXG_BAR_StateClosed(),param1.additionalIcon);
                  break;
               case ActorState.HALF_2:
                  this.setStateImage(new FXG_BAR_StateNotClosed(),param1.additionalIcon);
                  break;
               default:
      ...
      private function _BarrierStateImage_Array1_c() : Array
      {
         var _loc1_:Array = [this._BarrierStateImage_Group1_i()];
         return _loc1_;
      }
      
      private function _BarrierStateImage_Group1_i() : Group
      {
      ...
      private function _BarrierStateImage_bindingsSetup() : Array
      {
         var result:Array = [];
