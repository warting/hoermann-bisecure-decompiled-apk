package refactor.bisecur._1_APP.components.stateImages
{
   ...
   public class Pilomat_PollerStateImage extends StateImageBase implements IBindingClient
   {
      ...
      public function Pilomat_PollerStateImage()
      {
         ...
         {
            watcherSetupUtilClass = getDefinitionByName("_refactor_bisecur__1_APP_components_stateImages_Pilomat_PollerStateImageWatcherSetupUtil");
         ...
         if(param1.showState && param1.requestable)
         {
            switch(param1.actorState)
            {
               ...
               default:
                  ...
                  Log.error(Pilomat_PollerStateImage + param1.actorState + Pilomat_PollerStateImage);
            }
         }
