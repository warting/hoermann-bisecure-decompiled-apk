package refactor.bisecur._1_APP.components.stateImages
{
   ...
   import refactor.bisecur._1_APP.skins.stateImage.JackStateImageSkin;
   ...
   public class JackStateImage extends StateImageBase implements IBindingClient
   {
      ...
      public function JackStateImage()
      {
         ...
         {
            watcherSetupUtilClass = getDefinitionByName("_refactor_bisecur__1_APP_components_stateImages_JackStateImageWatcherSetupUtil");
