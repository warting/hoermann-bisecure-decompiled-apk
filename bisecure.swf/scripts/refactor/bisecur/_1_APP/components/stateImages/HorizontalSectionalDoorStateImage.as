package refactor.bisecur._1_APP.components.stateImages
{
   ...
   public class HorizontalSectionalDoorStateImage extends StateImageBase implements IBindingClient
   {
      ...
      public function HorizontalSectionalDoorStateImage()
      {
         ...
         {
            watcherSetupUtilClass = getDefinitionByName("_refactor_bisecur__1_APP_components_stateImages_HorizontalSectionalDoorStateImageWatcherSetupUtil");
         ...
         if(param1.showState && param1.requestable)
         {
            switch(param1.actorState)
            {
               ...
               default:
                  ...
                  Log.error("[HorizontalSectionalDoorStateImage] ActorState \'" + param1.actorState + "\' is not available for HorizontalSectionalDoorStateImage!");
            }
         }
