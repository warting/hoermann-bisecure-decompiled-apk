package refactor.bisecur._1_APP.components.stateImages
{
   ...
   public class SectionalDoorStateImage extends StateImageBase implements IBindingClient
   {
      ...
      public function SectionalDoorStateImage()
      {
         ...
         {
            watcherSetupUtilClass = getDefinitionByName("_refactor_bisecur__1_APP_components_stateImages_SectionalDoorStateImageWatcherSetupUtil");
         ...
         if(param1.showState && param1.requestable)
         {
            switch(param1.actorState)
            {
               ...
               default:
                  ...
                  Log.error("[SectionalDoorStateImage] ActorState \'" + param1.actorState + "\' is not available for SectionalDoorStateImage!");
            }
         }
