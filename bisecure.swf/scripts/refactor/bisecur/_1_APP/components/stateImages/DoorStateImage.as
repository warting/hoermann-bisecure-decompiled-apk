package refactor.bisecur._1_APP.components.stateImages
{
   ...
   import refactor.bisecur._1_APP.skins.stateImage.DoorStateImageSkin;
   ...
   public class DoorStateImage extends StateImageBase implements IBindingClient
   {
      ...
      public function DoorStateImage()
      {
         ...
         {
            watcherSetupUtilClass = getDefinitionByName("_refactor_bisecur__1_APP_components_stateImages_DoorStateImageWatcherSetupUtil");
