package refactor.bisecur._1_APP.components
{
   ...
   public class GatewayDisplay extends SkinnableContainer implements IBindingClient
   {
      ...
      public function GatewayDisplay()
      {
         ...
         {
            watcherSetupUtilClass = getDefinitionByName("_refactor_bisecur__1_APP_components_GatewayDisplayWatcherSetupUtil");
      ...
      override protected function createChildren() : void
      {
         ...
         this.gwName.text = AppCache.sharedCache.connectedGateway.gateway.name;
      }
