package refactor.bisecur._1_APP.components.popups
{
   ...
   public class Popup extends SkinnablePopUpContainer
   {
      ...
      protected static var openedPopups:Array = [];
      ...
      public function openAsync(param1:Function) : void
      {
         var onClose:Function = null;
         var callback:Function = param1;
         onClose = function(param1:PopUpEvent):void
         {
            removeEventListener(PopUpEvent.CLOSE,onClose);
            if(callback != null)
            {
               callback(param1);
            }
         };
         addEventListener(PopUpEvent.CLOSE,onClose);
         this.open(null);
      }
      ...
      override public function open(param1:DisplayObjectContainer, param2:Boolean = false) : void
      {
         if(param1 == null)
         {
            param1 = FlexGlobals.topLevelApplication as DisplayObjectContainer;
         }
         if(param1 is UIComponent)
         {
            this.styleName = (param1 as UIComponent).styleName;
         }
         FlexHelper.getNavigator().activeView.addEventListener(FlexEvent.BACK_KEY_PRESSED,this.onBackKey);
      ...
      override public function close(param1:Boolean = false, param2:* = null) : void
      {
         ...
         FlexHelper.getNavigator().activeView.removeEventListener(FlexEvent.BACK_KEY_PRESSED,this.onBackKey);
