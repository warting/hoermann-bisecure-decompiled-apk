package refactor.bisecur._1_APP.components.popups
{
   ...
   public class AppInfoBox extends ErrorBox
   {
      ...
      {
         Log.info("[AppInfoBox] longPress recognized!");
      }
      ...
      private function onLongPressFinished(param1:LongPressEvent) : void
      {
         if(this.isUpsideDown(param1))
         {
            ...
            this.passwordInput.open(FlexGlobals.topLevelApplication as DisplayObjectContainer);
         }
      }
      
      private function onPasswordInputClose(param1:PopUpEvent) : void
      {
         var _loc2_:ViewNavigator = null;
         ...
         {
            _loc2_ = FlexHelper.getNavigator();
            _loc2_.pushView(ChangeFeatureScreen);
            this.close();
         }
      }
