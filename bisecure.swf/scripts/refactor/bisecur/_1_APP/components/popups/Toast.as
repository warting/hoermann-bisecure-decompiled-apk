package refactor.bisecur._1_APP.components.popups
{
   ...
   public class Toast extends SkinnablePopUpContainer implements IBindingClient
   {
      ...
      public function Toast()
      {
         ...
         {
            watcherSetupUtilClass = getDefinitionByName("_refactor_bisecur__1_APP_components_popups_ToastWatcherSetupUtil");
      ...
      public static function show(param1:String, param2:int) : Toast
      {
         ...
         toast.open(UIComponent(FlexGlobals.topLevelApplication));
         return toast;
      }
