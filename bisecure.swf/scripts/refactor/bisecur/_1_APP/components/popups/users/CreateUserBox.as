package refactor.bisecur._1_APP.components.popups.users
{
   ...
   public class CreateUserBox extends Popup
   {
      ...
      private function onOkClick(param1:MouseEvent) : void
      {
         ...
         {
            _loc2_.title = Lang.getString("CHANGE_PWD_USER_INVALID");
            _loc2_.contentText = Lang.getString("CHANGE_PWD_USER_INVALID_CONTENT");
         ...
         {
            _loc2_.title = Lang.getString("CHANGE_PWD_NEW_PASSWORD_INVALID");
            _loc2_.contentText = Lang.getString("CHANGE_PWD_NEW_PASSWORD_INVALID_CONTENT");
            _loc2_.closeable = true;
            _loc2_.closeTitle = Lang.getString("GENERAL_SUBMIT");
            _loc2_.open(null);
            return;
         ...
         {
            _loc2_.title = Lang.getString("CHANGE_PWD_PASSWORD_NOT_EQUAL");
            _loc2_.contentText = Lang.getString("CHANGE_PWD_PASSWORD_NOT_EQUAL_CONTENT");
            _loc2_.closeable = true;
            _loc2_.closeTitle = Lang.getString("GENERAL_SUBMIT");
            _loc2_.open(null);
            return;
