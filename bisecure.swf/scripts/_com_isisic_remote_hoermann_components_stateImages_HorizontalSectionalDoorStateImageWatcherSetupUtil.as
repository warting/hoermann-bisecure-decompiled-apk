package
{
   ...
   public class _com_isisic_remote_hoermann_components_stateImages_HorizontalSectionalDoorStateImageWatcherSetupUtil implements IWatcherSetupUtil2
   {
       
      
      public function _com_isisic_remote_hoermann_components_stateImages_HorizontalSectionalDoorStateImageWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         HorizontalSectionalDoorStateImage.watcherSetupUtil = new _com_isisic_remote_hoermann_components_stateImages_HorizontalSectionalDoorStateImageWatcherSetupUtil();
      }
