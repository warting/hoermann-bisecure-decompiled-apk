package
{
   ...
   public class _refactor_bisecur__1_APP_components_stateImages_SwingGateDoubleStateImageWatcherSetupUtil implements IWatcherSetupUtil2
   {
       
      
      public function _refactor_bisecur__1_APP_components_stateImages_SwingGateDoubleStateImageWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         SwingGateDoubleStateImage.watcherSetupUtil = new _refactor_bisecur__1_APP_components_stateImages_SwingGateDoubleStateImageWatcherSetupUtil();
      }
