package mx.collections
{
   ...
   public class ListCollectionView extends Proxy implements ICollectionView, IList, IMXMLObject
   {
      ...
      private function handlePropertyChangeEvents(param1:Array) : void
      {
         ...
         var _loc18_:int = 0;
         var _loc19_:CollectionEvent = null;
         ...
         if(this.sort || this.filterFunction != null)
         {
            ...
            while(_loc5_ < param1.length)
            {
               ...
               while(_loc11_ < _loc3_.length)
               {
                  ...
                  {
                     _loc12_ = _loc3_[_loc11_].events as Array;
               ...
               {
                  _loc15_ = _loc8_.oldValue != null || _loc8_.newValue != null;
                  _loc16_ = _loc8_.property == null && _loc15_;
                  _loc17_ = _loc8_.property == null && !_loc15_;
                  _loc4_ = {
                     "item":_loc9_,
                     "move":_loc10_,
                     "events":[_loc8_],
                     "undefinedChange":_loc17_,
                     "objectReplacedWithAnother":_loc16_,
                     "oldItem":_loc8_.oldValue
                  };
                  _loc3_.push(_loc4_);
               }
               _loc4_.move = _loc4_.move || this.filterFunction != null || _loc4_.objectReplacedWithAnother || _loc4_.undefinedChange || this.sort && this.sort.propertyAffectsSort(String(_loc8_.property));
               _loc5_++;
            }
            _loc2_ = [];
            _loc5_ = 0;
            while(_loc5_ < _loc3_.length)
            {
               ...
               if(_loc4_.move)
               {
                  if(_loc4_.objectReplacedWithAnother)
                  {
                     this.removeItemsFromView([_loc4_.oldItem],-1,true);
                  }
                  this.moveItemInView(_loc4_.item,_loc4_.item != null,_loc2_);
               }
               else
               {
            ...
            {
               _loc18_ = 0;
               while(_loc18_ < _loc3_.length)
               {
                  if(_loc2_[_loc7_] == _loc3_[_loc18_].item)
                  {
                     _loc6_ = _loc6_.concat(_loc3_[_loc18_].events);
                  }
                  _loc18_++;
               }
               _loc7_++;
         ...
         if(_loc2_.length > 0)
         {
            _loc19_ = new CollectionEvent(CollectionEvent.COLLECTION_CHANGE);
            _loc19_.kind = CollectionEventKind.UPDATE;
            _loc19_.items = _loc2_;
            this.dispatchEvent(_loc19_);
         }
      }
      ...
      public function set complexFieldWatcher(param1:ComplexFieldChangeWatcher) : void
      {
         if(this._complexFieldWatcher != param1)
         {
            this.stopWatchingForComplexFieldsChanges();
            this._complexFieldWatcher = param1;
      ...
      private function onComplexFieldValueChanged(param1:PropertyChangeEvent) : void
      {
         if(this.sort)
         {
            this.moveItemInView(param1.source);
         }
      }
   }
}
