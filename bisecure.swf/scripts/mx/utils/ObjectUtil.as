package mx.utils
{
   ...
   public class ObjectUtil
   {
      ...
      public static function getEnumerableProperties(param1:Object) : Array
      {
         var _loc3_:* = null;
         var _loc2_:Array = [];
         if(!isDynamicObject(param1))
         {
            return _loc2_;
         }
      ...
      public static function valuesAreSubsetOfObject(param1:Object, param2:Object) : Boolean
      {
         ...
         var _loc4_:Boolean = _loc3_.length > 0 || ObjectUtil.isDynamicObject(param1);
         for each(_loc5_ in _loc3_)
         {
            if(!param2.hasOwnProperty(_loc5_) || param2[_loc5_] != param1[_loc5_])
            {
               _loc4_ = false;
               break;
            }
      ...
      public static function getValue(param1:Object, param2:Array) : *
      {
         if(!param1)
         {
            return undefined;
         ...
         var _loc3_:* = param1;
         var _loc4_:int = -1;
         while(++_loc4_ < param2.length && _loc3_)
         {
            _loc3_ = !!_loc3_.hasOwnProperty(param2[_loc4_])?_loc3_[param2[_loc4_]]:undefined;
         }
         return _loc3_;
      }
      
      public static function setValue(param1:Object, param2:Array, param3:*) : Boolean
      {
         if(!param1 || !param2 || !param2.length)
         {
            return false;
         }
         var _loc4_:* = getValue(param1,param2.slice(0,-1));
         if(_loc4_ && _loc4_.hasOwnProperty(param2[param2.length - 1]))
         {
            _loc4_[param2[param2.length - 1]] = param3;
            return true;
         }
         return false;
      }
