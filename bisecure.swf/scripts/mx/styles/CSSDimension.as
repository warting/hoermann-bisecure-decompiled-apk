package mx.styles
{
   ...
   public class CSSDimension
   {
      ...
      public function CSSDimension(param1:Number, param2:Number, param3:String = "")
      {
         super();
         this._value = param1;
         this._unit = param3;
         this._pixelValue = this.computePixelValue(param2);
      }
      ...
      public function compareTo(param1:CSSDimension) : int
      {
         return ObjectUtil.numericCompare(this._pixelValue,param1.pixelValue);
      }
      ...
      private function computePixelValue(param1:Number) : int
      {
         switch(this._unit)
         {
            case UNIT_INCH:
            ...
            case UNIT_DP:
               return this._value * param1 / DP_PER_INCH;
            case UNIT_CM:
               return this._value * param1 / CM_PER_INCH;
            case UNIT_PT:
               return this._value * param1 / PT_PER_INCH;
            default:
               return this._value;
         }
      }
