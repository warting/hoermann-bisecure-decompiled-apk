package
{
   ...
   public class _refactor_bisecur__1_APP_components_stateImages_Pilomat_PollerStateImageWatcherSetupUtil implements IWatcherSetupUtil2
   {
       
      
      public function _refactor_bisecur__1_APP_components_stateImages_Pilomat_PollerStateImageWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         Pilomat_PollerStateImage.watcherSetupUtil = new _refactor_bisecur__1_APP_components_stateImages_Pilomat_PollerStateImageWatcherSetupUtil();
      }
