package org.apache.flex.collections
{
   ...
   public class ArrayList extends EventDispatcher implements IList, IExternalizable, IPropertyChangeNotifier
   {
      ...
      public function removeItemAt(param1:int) : Object
      {
         ...
         {
            _loc3_ = this.source.splice(param1,1)[0];
         }
         else if(param1 == _loc2_)
         {
            _loc3_ = this.source.pop();
         }
         else if(param1 == 0)
         {
            _loc3_ = this.source.shift();
         }
         else
         {
            _loc4_ = this.resourceManager.getString("collections","outOfBounds",[param1]);
            throw new RangeError(_loc4_);
         }
         this.stopTrackUpdates(_loc3_);
         this.internalDispatchEvent(CollectionEventKind.REMOVE,_loc3_,param1);
         return _loc3_;
      }
      ...
      public function itemUpdated(param1:Object, param2:Object = null, param3:Object = null, param4:Object = null) : void
      {
         ...
         {
            this.dispatchPropertyChangeEventClone(_loc5_,param1);
         }
      }
      ...
      private function dispatchPropertyChangeEventClone(param1:PropertyChangeEvent, param2:Object) : void
      {
         var _loc3_:PropertyChangeEvent = PropertyChangeEvent(param1.clone());
         var _loc4_:int = this.getItemIndex(param2);
         _loc3_.property = _loc4_.toString() + "." + param1.property;
      ...
      protected function itemUpdateHandler(param1:PropertyChangeEvent) : void
      {
         ...
         if(this._dispatchEvents == 0 && hasEventListener(PropertyChangeEvent.PROPERTY_CHANGE))
         {
            this.dispatchPropertyChangeEventClone(param1,param1.target);
         }
      }
