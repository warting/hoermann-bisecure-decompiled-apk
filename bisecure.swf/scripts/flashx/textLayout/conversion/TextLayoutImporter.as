package flashx.textLayout.conversion
{
   ...
   public class TextLayoutImporter extends BaseTextLayoutImporter implements ITextLayoutImporter
   {
      ...
      public static function parseTable(param1:BaseTextLayoutImporter, param2:XML, param3:FlowGroupElement) : void
      {
         var _loc4_:TableElement = TextLayoutImporter(param1).createTableFromXML(param2);
         if(param1.addChild(param3,_loc4_))
         {
            param1.parseFlowGroupElementChildren(param2,_loc4_);
         }
      ...
      public static function parseTableRow(param1:BaseTextLayoutImporter, param2:XML, param3:FlowGroupElement) : void
      {
         var _loc5_:TableElement = null;
         var _loc6_:int = 0;
         var _loc4_:TableRowElement = TextLayoutImporter(param1).createTableRowFromXML(param2);
         if(param1.addChild(param3,_loc4_))
         {
            param1.parseFlowGroupElementChildren(param2,_loc4_);
            _loc5_ = _loc4_.getTable();
            _loc6_ = _loc4_.getColumnCount();
            if(_loc5_.numColumns < _loc6_)
            {
               _loc5_.numColumns = _loc6_;
            }
            _loc5_.insertRow(_loc4_,_loc4_.mxmlChildren);
         }
      }
      
      public static function parseTableCell(param1:BaseTextLayoutImporter, param2:XML, param3:FlowGroupElement) : void
      {
         var _loc4_:TableCellElement = TextLayoutImporter(param1).createTableCellFromXML(param2);
         if(param1.addChild(param3,_loc4_))
         {
            param1.parseTableCellElementChildren(param2,_loc4_);
         }
         TableRowElement(param3).addCell(_loc4_);
      }
      
      public static function getTextFlowContent(param1:String = null, param2:Boolean = false, param3:Boolean = false) : TextFlow
      {
         var _loc4_:TextFlow = new TextFlow();
         ...
         _loc5_.backgroundAlpha = 0.2;
         _loc5_.backgroundColor = 16711680;
      ...
      public function createTableFromXML(param1:XML) : TableElement
      {
         var _loc2_:TableElement = new TableElement();
         this.parseStandardFlowElementAttributes(_loc2_,param1);
         return _loc2_;
      }
      
      public function createTableRowFromXML(param1:XML) : TableRowElement
      {
         var _loc2_:TableRowElement = new TableRowElement();
         this.parseStandardFlowElementAttributes(_loc2_,param1);
         return _loc2_;
      }
      
      public function createTableCellFromXML(param1:XML) : TableCellElement
      {
         var _loc2_:TableCellElement = new TableCellElement();
         this.parseStandardFlowElementAttributes(_loc2_,param1);
         return _loc2_;
      }
