package flashx.textLayout.conversion
{
   ...
   class TextLayoutExporter extends BaseTextLayoutExporter
   {
      ...
      public static function exportTable(param1:BaseTextLayoutExporter, param2:TableElement) : XMLList
      {
         return exportTableElement(param1,param2);
      }
      
      public static function exportTableRow(param1:BaseTextLayoutExporter, param2:TableRowElement) : XMLList
      {
         return exportTableRowElement(param1,param2);
      }
      
      public static function exportTableCell(param1:BaseTextLayoutExporter, param2:TableCellElement) : XMLList
      {
         return exportTableCellElement(param1,param2);
      }
