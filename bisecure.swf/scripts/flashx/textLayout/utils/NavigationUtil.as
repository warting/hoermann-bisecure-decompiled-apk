package flashx.textLayout.utils
{
   ...
   public final class NavigationUtil
   {
      ...
      tlf_internal static function computeEndIdx(param1:TextFlowLine, param2:TextFlowLine, param3:String, param4:Boolean, param5:Point) : int
      {
         ...
         var _loc8_:int = param1.paragraph.getTextBlockAbsoluteStart(_loc7_.textBlock);
         var _loc9_:TextLine = param2.getTextLine(true);
         var _loc10_:* = _loc9_.getAtomBidiLevel(_loc11_) % 2 != 0;
         if(param1.controller == param2.controller)
         {
            if(param3 != BlockProgression.RL)
            {
               param5.y = param5.y - (_loc9_.y - _loc7_.y);
            }
            else
            {
               param5.x = param5.x + (_loc7_.x - _loc9_.x);
            }
         }
         else
         {
            _loc12_ = _loc7_.getAtomBounds(0);
            _loc13_ = new Point();
            _loc13_.x = _loc12_.left;
            _loc13_.y = 0;
            _loc13_ = _loc7_.localToGlobal(_loc13_);
            if(param3 != BlockProgression.RL)
            {
         ...
         _loc11_ = _loc7_.getAtomIndexAtPoint(param5.x,param5.y);
         if(_loc11_ == -1)
         {
            if(param3 != BlockProgression.RL)
            {
         ...
         {
            _loc14_ = _loc7_.getAtomBounds(_loc11_);
            _loc15_ = false;
            if(_loc14_)
            {
               _loc17_ = new Point();
               _loc17_.x = _loc14_.x;
               _loc17_.y = _loc14_.y;
               _loc17_ = _loc7_.localToGlobal(_loc17_);
               if(param3 == BlockProgression.RL && _loc7_.getAtomTextRotation(_loc11_) != TextRotation.ROTATE_0)
               {
                  _loc15_ = param5.y > _loc17_.y + _loc14_.height / 2;
               }
               else
               {
                  _loc15_ = param5.x > _loc17_.x + _loc14_.width / 2;
               }
            }
            if(_loc7_.getAtomBidiLevel(_loc11_) % 2 != 0)
            {
               _loc16_ = !!_loc15_?int(_loc7_.getAtomTextBlockBeginIndex(_loc11_)):int(_loc7_.getAtomTextBlockEndIndex(_loc11_));
            }
            else if(param4)
            {
               if(_loc15_ == false && _loc11_ > 0)
               {
                  _loc16_ = _loc7_.getAtomTextBlockBeginIndex(_loc11_ - 1);
               }
               else
               {
                  _loc16_ = _loc7_.getAtomTextBlockBeginIndex(_loc11_);
               }
            }
            else
            {
               _loc16_ = !!_loc15_?int(_loc7_.getAtomTextBlockEndIndex(_loc11_)):int(_loc7_.getAtomTextBlockBeginIndex(_loc11_));
            }
      ...
      public static function nextLine(param1:TextRange, param2:Boolean = false) : Boolean
      {
         ...
         var _loc24_:ContainerController = null;
         var _loc25_:int = 0;
         var _loc26_:int = 0;
         ...
         if(_loc8_ < _loc3_.flowComposer.numLines - 1)
         {
            ...
            _loc14_ = _loc10_.paragraph.getTextBlockAbsoluteStart(_loc13_.textBlock);
            _loc15_ = _loc13_.getAtomIndexAtCharIndex(_loc6_ - _loc14_);
            ...
            _loc22_ = 1;
            _loc23_ = _loc3_.flowComposer.getLineAt(_loc8_ + _loc22_);
            while(_loc23_ is TextFlowTableBlock)
            {
               _loc23_ = _loc3_.flowComposer.getLineAt(++_loc22_ + _loc8_);
            }
            if(!_loc23_ || _loc23_.absoluteStart >= _loc7_)
            {
               if(!param2)
               {
            ...
            _loc24_ = _loc3_.flowComposer.getControllerAt(_loc3_.flowComposer.numControllers - 1);
            _loc25_ = _loc24_.absoluteStart;
            _loc26_ = _loc25_ + _loc24_.textLength;
            if(_loc23_.absoluteStart >= _loc25_ && _loc23_.absoluteStart < _loc26_)
            {
               if(_loc23_.isDamaged())
               {
                  _loc3_.flowComposer.composeToPosition(_loc23_.absoluteStart + 1);
                  _loc23_ = _loc3_.flowComposer.getLineAt(_loc8_ + 1);
                  if(_loc23_.isDamaged())
                  {
                     return false;
                  }
               }
               _loc27_ = _loc4_ == BlockProgression.TB?Number(_loc24_.horizontalScrollPosition):Number(_loc24_.verticalScrollPosition);
               _loc24_.scrollToRange(_loc23_.absoluteStart,_loc23_.absoluteStart + _loc23_.textLength - 1);
               if(_loc4_ == BlockProgression.TB)
               {
                  _loc24_.horizontalScrollPosition = _loc27_;
               }
               else
               {
                  _loc24_.verticalScrollPosition = _loc27_;
               }
            }
            _loc6_ = computeEndIdx(_loc23_,_loc10_,_loc4_,_loc9_,_loc21_);
      ...
      public static function previousLine(param1:TextRange, param2:Boolean = false) : Boolean
      {
         ...
         if(_loc7_ > 0)
         {
            ...
            _loc13_ = _loc9_.paragraph.getTextBlockAbsoluteStart(_loc12_.textBlock);
            _loc14_ = _loc12_.getAtomIndexAtCharIndex(_loc6_ - _loc13_);
            ...
            _loc20_ = 1;
            _loc21_ = _loc3_.flowComposer.getLineAt(_loc7_ - _loc20_);
            while(_loc21_ is TextFlowTableBlock)
            {
               _loc21_ = _loc3_.flowComposer.getLineAt(_loc7_ - ++_loc20_);
            }
            if(!_loc21_)
            {
               if(!param2)
               {
                  param1.activePosition = param1.anchorPosition = 0;
               }
               else
               {
                  param1.activePosition = 0;
               }
               return true;
            }
            ...
            {
               _loc25_ = _loc4_ == BlockProgression.TB?Number(_loc22_.horizontalScrollPosition):Number(_loc22_.verticalScrollPosition);
               _loc22_.scrollToRange(_loc21_.absoluteStart,_loc21_.absoluteStart + _loc21_.textLength - 1);
               if(_loc4_ == BlockProgression.TB)
               {
                  _loc22_.horizontalScrollPosition = _loc25_;
               }
               else
               {
                  _loc22_.verticalScrollPosition = _loc25_;
               }
            }
            _loc6_ = computeEndIdx(_loc21_,_loc9_,_loc4_,_loc8_,_loc19_);
         }
         else
         {
            _loc6_ = 0;
