package flashx.textLayout.compose
{
   ...
   public class TextFlowLine implements IVerticalJustificationLine
   {
      ...
      public function get location() : int
      {
         ...
         if(this._para)
         {
            _loc2_ = this.peekTextLine();
            if(_loc2_)
            {
               _loc1_ = this._absoluteStart - this._para.getTextBlockAbsoluteStart(_loc2_.textBlock);
            }
            else
            {
      ...
      tlf_internal function peekTextLine() : TextLine
      {
         ...
         var _loc2_:Vector.<TextBlock> = this.paragraph.getTextBlocks();
         for each(_loc3_ in _loc2_)
         {
            _loc1_ = _loc3_.firstLine;
            while(_loc1_)
            {
      ...
      private function getTextLineInternal() : TextLine
      {
         ...
         var _loc2_:TextBlock = this.paragraph.getTextBlockAtPosition(this.absoluteStart - _loc1_);
         ...
         do
         {
            ...
            else if(_loc8_ is TextFlowTableBlock)
            {
               _loc7_ = null;
               _loc3_ = null;
            }
      ...
      private function getSelectionShapesCacheEntry(param1:int, param2:int, param3:TextFlowLine, param4:TextFlowLine, param5:String) : SelectionCache
      {
         ...
         var _loc6_:TextLine = this.getTextLine();
         var _loc7_:int = this._para.getTextBlockAbsoluteStart(_loc6_.textBlock);
         if(param1 == param2 && _loc7_ + param1 == this.absoluteStart)
         {
         ...
         var _loc8_:SelectionCache = _selectionBlockCache[this];
         if(_loc8_ && _loc8_.begIdx == param1 && _loc8_.endIdx == param2)
         {
            return _loc8_;
         }
         ...
         if(_loc8_ == null)
         {
            _loc8_ = new SelectionCache();
            _selectionBlockCache[this] = _loc8_;
         }
         else
         {
            _loc8_.clear();
         }
         _loc8_.begIdx = param1;
         _loc8_.endIdx = param2;
         var _loc11_:Array = this.getRomanSelectionHeightAndVerticalAdjustment(param3,param4);
         this.calculateSelectionBounds(_loc6_,_loc9_,param1,param2,param5,_loc11_);
         for each(_loc12_ in _loc9_)
         {
            _loc8_.pushSelectionBlock(_loc12_);
         }
         return _loc8_;
      }
      ...
      tlf_internal function calculateSelectionBounds(param1:TextLine, param2:Array, param3:int, param4:int, param5:String, param6:Array) : void
      {
         ...
         var _loc8_:int = this._para.getTextBlockAbsoluteStart(param1.textBlock);
         ...
         while(_loc9_ < param4)
         {
            ...
            else
            {
               ...
               if(_loc10_ is TableLeafElement)
               {
                  _loc9_++;
               }
               else
      ...
      tlf_internal function hiliteBlockSelection(param1:Shape, param2:SelectionFormat, param3:DisplayObject, param4:int, param5:int, param6:TextFlowLine, param7:TextFlowLine) : void
      {
         ...
         var _loc9_:int = this._para.getTextBlockAbsoluteStart(_loc8_.textBlock);
      ...
      tlf_internal function computePointSelectionRectangle(param1:int, param2:DisplayObject, param3:TextFlowLine, param4:TextFlowLine, param5:Boolean) : Rectangle
      {
         ...
         param1 = param1 - this._para.getTextBlockAbsoluteStart(_loc6_.textBlock);
         ...
         var _loc15_:Array = this.makeSelectionBlocks(_loc6_,param1,_loc7_,this._para.getTextBlockAbsoluteStart(_loc6_.textBlock),_loc12_,_loc13_,_loc14_);
      ...
      tlf_internal function selectionWillIntersectScrollRect(param1:Rectangle, param2:int, param3:int, param4:TextFlowLine, param5:TextFlowLine) : int
      {
         ...
         else
         {
            if(_loc8_)
            {
               _loc10_ = this._para.getTextBlockAbsoluteStart(_loc8_.textBlock);
            }
            else
            {
