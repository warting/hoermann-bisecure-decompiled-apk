package flashx.textLayout.compose
{
   ...
   public class BaseCompose
   {
      ...
      private function composeBlockElement(param1:FlowGroupElement, param2:int, param3:Boolean = false, param4:int = -1) : Boolean
      {
         ...
         var _loc11_:TableCellElement = null;
         var _loc12_:TableElement = null;
         ...
         var _loc19_:ParagraphElement = null;
         var _loc20_:Number = NaN;
         var _loc21_:ListItemElement = null;
         var _loc7_:Boolean = param1 is TextFlow && TextFlow(param1).parentElement is TableCellElement?true:false;
         var _loc8_:Number = 0;
         if(_loc7_)
         {
            _loc11_ = TextFlow(param1).parentElement as TableCellElement;
            _loc12_ = _loc11_.table;
            _loc8_ = _loc12_.cellSpacing != undefined?Number(_loc12_.cellSpacing):Number(0);
         }
         var _loc9_:int = 0;
         if(param4 != -1)
         {
         ...
         {
            _loc9_ = param1.findChildIndexAtPosition(this._curElementStart + this._curElementOffset - param2);
            _loc5_ = param1.getChildAt(_loc9_);
            param2 = param2 + _loc5_.parentRelativeStart;
            _loc13_ = this._textFlow.findLeaf(this._startComposePosition - 1);
            if(_loc13_)
            {
               _loc14_ = _loc13_.getParagraph();
               if(_loc14_ && _loc14_ != this._curElement.getParagraph())
               {
                  if(_loc14_.paddingBottom != undefined)
                  {
                     this._parcelList.addTotalDepth(_loc14_.paddingBottom);
                  }
               }
            }
         }
         var _loc10_:* = param2 == this._curElementStart + this._curElementOffset;
         while(_loc9_ < param1.numChildren && (param2 <= this._stopComposePos || !this.parcelList.atLast()))
         {
            _loc5_ = param1.getChildAt(_loc9_);
            if(_loc5_.computedFormat.clearFloats != ClearFloats.NONE)
            {
               _loc20_ = this._curParcel.applyClear(_loc5_.computedFormat.clearFloats,this._parcelList.totalDepth,_loc5_.computedFormat.direction);
               this._parcelList.addTotalDepth(_loc20_);
            ...
            if(this._blockProgression == BlockProgression.RL)
            {
               ...
               _loc17_ = _loc5_.getEffectivePaddingRight() + _loc5_.getEffectiveBorderRightWidth() + _loc5_.getEffectiveMarginRight();
               _loc18_ = _loc5_.getEffectivePaddingLeft() + _loc5_.getEffectiveBorderLeftWidth() + _loc5_.getEffectiveMarginLeft();
            }
            else
            {
               _loc15_ = _loc5_.getEffectivePaddingLeft() + _loc5_.getEffectiveBorderLeftWidth() + _loc5_.getEffectiveMarginLeft();
               _loc16_ = _loc5_.getEffectivePaddingRight() + _loc5_.getEffectiveBorderRightWidth() + _loc5_.getEffectiveMarginRight();
               _loc17_ = _loc5_.getEffectivePaddingTop() + _loc5_.getEffectiveBorderTopWidth() + _loc5_.getEffectiveMarginTop();
               _loc18_ = _loc5_.getEffectivePaddingBottom() + _loc5_.getEffectiveBorderBottomWidth() + _loc5_.getEffectiveMarginBottom();
               if(_loc7_)
               {
            ...
            this._parcelList.pushLeftMargin(_loc15_);
            this._parcelList.pushRightMargin(_loc16_);
            if(_loc10_ && _loc17_ > this._verticalSpaceCarried)
            {
               this._parcelList.addTotalDepth(_loc17_ - this._verticalSpaceCarried);
            }
            this._verticalSpaceCarried = Math.max(_loc17_,0);
            _loc19_ = _loc5_ as ParagraphElement;
            if(_loc19_)
            {
               if(!this._atColumnStart && _loc19_.computedFormat.columnBreakBefore == BreakStyle.ALWAYS)
               {
                  this.advanceToNextParcel();
               }
               if(!(this._atColumnStart && this._parcelList.currentParcel != null && this._parcelList.currentParcel.columnIndex == 0) && _loc19_.computedFormat.containerBreakBefore == BreakStyle.ALWAYS)
               {
                  this.advanceToNextContainer();
               }
               if(!this.composeParagraphElement(_loc19_,param2))
               {
                  BackgroundManager.collectBlock(this._textFlow,param1);
                  return false;
               }
               if(!(this._atColumnStart && this._parcelList.currentParcel != null && this._parcelList.currentParcel.columnIndex == 0) && _loc19_.computedFormat.containerBreakAfter == BreakStyle.ALWAYS)
               {
                  this.advanceToNextContainer();
               }
               if(!this._atColumnStart && _loc19_.computedFormat.columnBreakAfter == BreakStyle.ALWAYS)
               {
                  this.advanceToNextParcel();
               }
            }
            ...
            {
               _loc6_ = this.composeBlockElement(FlowGroupElement(_loc5_),param2);
               if(!_loc6_)
               {
                  BackgroundManager.collectBlock(this._textFlow,param1);
                  return false;
            ...
            {
               _loc21_ = this._listItemElement;
               this._listItemElement = _loc5_ as ListItemElement;
               _loc6_ = this.composeBlockElement(FlowGroupElement(_loc5_),param2);
               this._listItemElement = _loc21_;
               if(!_loc6_)
               {
                  BackgroundManager.collectBlock(this._textFlow,param1);
                  return false;
            ...
            if(_loc18_ > this._verticalSpaceCarried)
            {
               this._parcelList.addTotalDepth(_loc18_ - this._verticalSpaceCarried);
            }
            this._verticalSpaceCarried = Math.max(_loc18_,0);
            this._parcelList.popLeftMargin(_loc15_);
            this._parcelList.popRightMargin(_loc16_);
            _loc10_ = true;
            param2 = param2 + _loc5_.textLength;
            _loc9_++;
         }
         if(!(param1 is TableElement || param1 is TableRowElement || param1 is TableCellElement))
         {
            BackgroundManager.collectBlock(this._textFlow,param1);
         }
         return true;
      ...
      private function composeTableElement(param1:TableElement, param2:int) : Boolean
      {
         var _loc15_:Number = NaN;
         var _loc16_:int = 0;
         var _loc17_:TableRowElement = null;
         var _loc18_:Number = NaN;
         var _loc19_:Number = NaN;
         var _loc20_:TableCellElement = null;
         var _loc21_:TableColElement = null;
         ...
         {
            _loc15_ = !!isNaN(this._curParaElement.computedFormat.paragraphSpaceBefore)?Number(0):Number(this._curParaElement.computedFormat.paragraphSpaceBefore);
         }
         _loc15_ = !!this._atColumnStart?Number(0):Number(_loc15_);
         var _loc3_:Number = !!this._atColumnStart?Number(0):Number(this._paragraphSpaceCarried);
         if(_loc15_ != 0 || _loc3_ != 0)
         {
            this._parcelList.addTotalDepth(Math.max(_loc15_,_loc3_));
         }
         this._paragraphSpaceCarried = 0;
         ...
         param1.normalizeColumnWidths(this._lineSlug.width);
         param1.composeCells();
         var _loc4_:Number = param1.getHeaderHeight();
         var _loc5_:Number = param1.getFooterHeight();
         var _loc6_:Number = 0;
         var _loc7_:Boolean = false;
         var _loc8_:Vector.<Vector.<TableCellElement>> = param1.getHeaderRows();
         var _loc9_:Vector.<Vector.<TableCellElement>> = param1.getFooterRows();
         var _loc10_:Vector.<TableCellElement> = param1.getNextRow();
         var _loc11_:TextFlowTableBlock = param1.getFirstBlock();
         _loc11_.clear();
         _loc11_.y = this._parcelList.totalDepth;
         var _loc12_:Number = !!isNaN(this._lastLineDescent)?Number(0):Number(this._lastLineDescent);
         _loc11_.y = _loc11_.y + _loc12_;
         _loc11_.x = this._lineSlug.leftMargin;
         var _loc13_:Number = this._curParaFormat.direction == Direction.LTR?Number(this._lineSlug.leftMargin):Number(this._lineSlug.rightMargin);
         _loc11_.initialize(this._curParaElement,this._lineSlug.width,_loc13_ - this._parcelList.insideListItemMargin,param1.getAbsoluteStart(),1);
         var _loc14_:Boolean = true;
         while(_loc10_)
         {
            _loc16_ = _loc10_[0].rowIndex;
            _loc17_ = param1.getRowAt(_loc16_);
            _loc18_ = _loc17_.composedHeight;
            _loc19_ = _loc17_.totalHeight;
            while(false)
            {
            ...
            {
               _loc20_.y = _loc6_;
               _loc21_ = param1.getColumnAt(_loc20_.colIndex);
               if(_loc21_)
               {
                  _loc20_.x = _loc21_.x;
               }
               param1.addCellToBlock(_loc20_,_loc11_);
            }
            this._parcelList.addTotalDepth(_loc18_);
            _loc10_ = param1.getNextRow();
            _loc6_ = _loc6_ + _loc18_;
         }
         if(this._parcelList.currentParcel && _loc14_)
         {
            _loc11_.height = _loc6_;
            this.endTableBlock(_loc11_);
         }
      ...
      protected function endTableBlock(param1:TextFlowTableBlock) : void
      {
         this._curLine = param1;
         param1.setController(this._curParcel.controller,this._curParcel.columnIndex);
         BackgroundManager.collectTableBlock(this._textFlow,param1,this._parcelList.currentParcel.controller);
      ...
      private function advanceToComposeStartPosition() : Boolean
      {
         ...
         if(_loc2_.controller && _loc2_.controller.numFloats)
         {
            if(this._measuring)
            {
               return false;
      ...
      protected function composeParagraphElement(param1:ParagraphElement, param2:int) : Boolean
      {
         ...
         if(!this._paragraphContainsVisibleLines)
         {
            _loc5_ = param1.getTextBlocks();
            for each(_loc7_ in _loc5_)
            {
               _loc6_ = _loc7_.lastLine;
               while(_loc6_ && _loc4_)
               {
                  if(_loc6_.parent)
                  {
               ...
               if(_loc4_)
               {
                  ...
                  while(_loc6_)
                  {
                     _loc7_.releaseLines(_loc6_,_loc6_);
                  ...
                  param1.releaseTextBlock(_loc7_);
               }
            }
         }
      ...
      protected function composeParagraphElementIntoLines() : Boolean
      {
         ...
         while(_loc1_)
         {
            ...
            _loc7_ = this._curParaElement.getChildAt(this._curParaElement.findChildIndexAtPosition(this._curElementStart - this._curParaStart));
            if(_loc7_ is TableElement)
            {
               if(!this.composeTableElement(_loc7_ as TableElement,this._curElementStart))
               {
                  return false;
               }
               this._curElementOffset = 0;
            ...
            _loc8_ = this._curParaFormat.textAlign;
            if(_loc8_ == TextAlign.JUSTIFY)
            {
               _loc14_ = this._curLine.location;
               if(_loc14_ == TextFlowLineLocation.LAST || _loc14_ == TextFlowLineLocation.ONLY)
               {
                  _loc8_ = this._curParaFormat.textAlignLast;
               }
            }
            switch(_loc8_)
            {
               case TextAlign.START:
                  _loc8_ = this._curParaFormat.direction == Direction.LTR?TextAlign.LEFT:TextAlign.RIGHT;
                  break;
               case TextAlign.END:
                  _loc8_ = this._curParaFormat.direction == Direction.LTR?TextAlign.RIGHT:TextAlign.LEFT;
            }
            _loc9_ = TextFlowLine.findNumberLine(_loc2_);
            _loc10_ = _loc9_ && TextFlowLine.getNumberLineListStylePosition(_loc9_) == ListStylePosition.OUTSIDE || _loc8_ == TextAlign.CENTER || _loc8_ == TextAlign.RIGHT;
            if(Configuration.playerEnablesArgoFeatures)
            {
               if(_loc2_["hasTabs"])
               {
                  if(this._curParaFormat.direction == Direction.LTR)
                  {
                     if(!_loc9_ || TextFlowLine.getNumberLineListStylePosition(_loc9_) == ListStylePosition.INSIDE)
                     {
                        _loc10_ = false;
                     }
                     _loc8_ = TextAlign.LEFT;
                  }
                  else
                  {
                     _loc10_ = true;
                     _loc8_ = TextAlign.RIGHT;
                  }
               }
            }
            if(_loc10_)
            {
               _loc11_ = createAlignData(this._curLine);
               _loc11_.textLine = _loc2_;
               _loc11_.textAlign = _loc8_;
            }
            _loc12_ = this._atColumnStart && this._curParaFormat.leadingModel != LeadingModel.BOX?Number(0):Number(this._curLine.spaceBefore);
            _loc13_ = !!this._atColumnStart?Number(0):Number(this._paragraphSpaceCarried);
            if(_loc12_ != 0 || _loc13_ != 0)
            {
               this._parcelList.addTotalDepth(Math.max(_loc12_,_loc13_));
            }
            this._paragraphSpaceCarried = 0;
            if(this._verticalSpaceCarried != 0)
            {
            ...
            _loc11_ = this.calculateLineAlignmentAndBounds(_loc2_,_loc9_,_loc11_);
            if(_loc11_)
            {
               if(!this._alignLines)
               {
               ...
               this._alignLines.push(_loc11_);
               this._curLine.alignment = _loc8_;
            }
            if(_loc5_ != 0)
            {
               if(this._curParaFormat.direction == Direction.LTR)
            ...
            else
            {
               ...
               if(this._curElementOffset >= this._curElement.textLength)
               {
                  do
                  {
                     ...
                     {
                        _loc15_ = this._curElement;
                        while(_loc15_ && _loc15_ != this._curParaElement)
                        {
                           if(_loc15_ is LinkElement)
                           {
                              this._curInteractiveObjects[_loc15_] = _loc15_;
                           }
                           else if(_loc15_.hasActiveEventMirror())
                           {
                              this._curInteractiveObjects[_loc15_] = _loc15_;
                           }
      ...
      protected function createTextLine(param1:Number, param2:Boolean) : TextLine
      {
         ...
         var _loc5_:TextBlock = this._curParaElement.getTextBlockAtPosition(this._curElement.getElementRelativeStart(this._curParaElement));
         if(_loc4_)
         {
         ...
         this._curLine.initialize(this._curParaElement,param1,_loc3_ - this._parcelList.insideListItemMargin,this._curLineStart,_loc4_.rawTextLength,_loc4_);
         return _loc4_;
      }
