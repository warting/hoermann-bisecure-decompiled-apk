package flashx.textLayout.compose
{
   ...
   public class FlowComposerBase
   {
      ...
      public function isPotentiallyDamaged(param1:int) : Boolean
      {
         return this.isDamaged(param1);
      }
      ...
      public function addLine(param1:TextFlowLine, param2:int) : void
      {
         ...
         else if(_loc3_ is TextFlowTableBlock && _loc3_ != param1)
         {
            this._lines.splice(param2,1,param1);
         }
         else if(param1 is TextFlowTableBlock)
         {
            if(_loc3_ != param1)
            {
               ...
               {
                  _loc3_.setAbsoluteStart(_loc3_.absoluteStart + 1);
               }
            }
         }
