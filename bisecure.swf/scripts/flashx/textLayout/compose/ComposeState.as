package flashx.textLayout.compose
{
   ...
   public class ComposeState extends BaseCompose
   {
      ...
      override protected function applyVerticalAlignmentToColumn(param1:ContainerController, param2:String, param3:Array, param4:int, param5:int, param6:int, param7:int) : void
      {
         ...
         {
            if(_loc8_ is TextLine)
            {
               _loc9_ = _loc8_ as TextLine;
               _loc10_ = _loc9_.userData as TextFlowLine;
               _loc10_.createShape(_blockProgression,_loc9_);
            }
         }
      }
      ...
      override protected function endTableBlock(param1:TextFlowTableBlock) : void
      {
         super.endTableBlock(param1);
         (_flowComposer as StandardFlowComposer).addLine(param1,this._curLineIndex);
