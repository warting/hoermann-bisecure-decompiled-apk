package flashx.textLayout.container
{
   ...
   public class ContainerController implements IInteractionEventHandler, ITextLayoutFormat, ISandboxSupport
   {
      ...
      tlf_internal function gatherVisibleLines(param1:String, param2:Boolean) : void
      {
         ...
         if(this._textLength != 0)
         {
            ...
            if(this.columnCount == 1)
            {
               ...
               while(_loc14_ && _loc14_ is TextFlowTableBlock)
               {
                  _loc14_ = _loc11_.getLineAt(_loc18_++);
               }
               _loc17_ = this.testLineVisible(param1,_loc7_,_loc8_,_loc9_,_loc10_,_loc14_,null);
               _loc15_ = _loc17_ as TextLine;
               _loc12_++;
               if(_loc15_)
               {
                  if(param2)
               ...
               else
               {
                  ...
                  {
                     _loc20_ = (_loc12_ + _loc19_) / 2;
                     _loc14_ = _loc11_.getLineAt(_loc20_);
                     _loc17_ = this.testLineVisible(param1,_loc7_,_loc8_,_loc9_,_loc10_,_loc14_,null);
                     if(_loc17_ && _loc17_ is TextLine)
                     {
                        _loc15_ = _loc17_ as TextLine;
                        _loc21_ = _loc11_.getLineAt(_loc20_ - 1);
                        if(!(this.testLineVisible(param1,_loc7_,_loc8_,_loc9_,_loc10_,_loc21_,null) is TextLine))
                        {
                           if(param2)
                           {
                              _loc14_.createShape(param1,_loc15_);
               ...
               while(_loc16_ <= _loc13_)
               {
                  ...
                  _loc17_ = this.testLineVisible(param1,_loc7_,_loc8_,_loc9_,_loc10_,_loc14_,null);
                  if(!(_loc17_ is TableBlockContainer))
                  {
                     _loc15_ = _loc17_ as TextLine;
                     if(!_loc15_)
                     {
      ...
      private function stopMouseSelectionScrolling(param1:IEventDispatcher = null) : void
      {
         if(this._scrollTimer)
         {
            ...
            if(!param1)
            {
               param1 = this.getContainerRoot();
            }
            if(param1)
            {
               param1.removeEventListener(MouseEvent.MOUSE_UP,this.scrollTimerHandler);
            }
      ...
      tlf_internal function addCellSelectionShapes(param1:uint, param2:TextFlowTableBlock, param3:CellCoordinates, param4:CellCoordinates) : void
      {
         var _loc7_:TableCellElement = null;
         var _loc8_:TableRowElement = null;
         var _loc9_:Rectangle = null;
         if(!param2)
         {
            return;
         }
         if(!param3.isValid() || !param4.isValid())
         {
            return;
         }
         var _loc5_:Vector.<TableCellElement> = param2.getCellsInRange(param3,param4);
         var _loc6_:Shape = new Shape();
         _loc6_.graphics.beginFill(param1);
         for each(_loc7_ in _loc5_)
         {
            _loc8_ = _loc7_.getRow();
            _loc9_ = new Rectangle(_loc7_.x,_loc7_.y + param2.y,_loc7_.width,_loc8_.composedHeight);
            _loc6_.graphics.drawRect(_loc9_.x,_loc9_.y,_loc9_.width,_loc9_.height);
         }
         this.addSelectionChild(_loc6_);
      }
      
      tlf_internal function addCellSelections(param1:Array, param2:uint, param3:TextFlowTableBlock) : void
      {
         ...
         {
            _loc6_ = _loc5_.getRow();
            _loc7_ = new Rectangle(_loc5_.x,_loc5_.y + param3.y,_loc5_.width,_loc6_.composedHeight);
            _loc4_.graphics.drawRect(_loc7_.x,_loc7_.y,_loc7_.width,_loc7_.height);
         }
         this.addSelectionChild(_loc4_);
      }
      ...
      tlf_internal function clearCompositionResults() : void
      {
         ...
         for each(_loc1_ in this._shapeChildren)
         {
            ...
            {
               this.removeTextLine(_loc1_ as TextLine);
            }
            else
            {
               this.removeTableBlock(_loc1_ as TableBlockContainer);
            }
         }
      ...
      private function intersperseTableBlocks(param1:Array) : void
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:int = (this._tableBlocksInView[0] as TableBlockContainer).userData.parentTable.getAbsoluteStart();
         var _loc4_:int = 0;
         while(_loc4_ < param1.length)
         {
            if(param1[_loc4_].userData.absoluteStart >= _loc3_)
            {
               param1.splice(_loc4_,0,this._tableBlocksInView[_loc2_++]);
               if(_loc2_ == this._tableBlocksInView.length)
               {
                  break;
               }
            }
         ...
         while(_loc2_ < this._tableBlocksInView.length)
         {
            param1.push(this._tableBlocksInView[_loc2_++]);
         }
      }
      ...
      tlf_internal function updateCompositionShapes() : void
      {
         ...
         this.intersperseTableBlocks(_loc4_);
         var _loc5_:int = this.getFirstTextLineChildIndex();
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         if(this._updateStart > this.absoluteStart && _loc4_.length > 0)
         {
            _loc13_ = TextFlowLine(_loc4_[0].userData);
            _loc14_ = this.flowComposer.findLineAtPosition(_loc13_.absoluteStart - 1);
            if(_loc14_ is TextFlowTableBlock)
            {
               _loc7_ = this._shapeChildren.indexOf((_loc14_ as TextFlowTableBlock).container);
            }
            else
            {
               _loc15_ = _loc14_.peekTextLine();
               _loc7_ = this._shapeChildren.indexOf(_loc15_);
            }
            if(_loc7_ >= 0)
            {
               _loc7_++;
         ...
         {
            _loc16_ = _loc4_[_loc6_];
            if(_loc16_ == this._shapeChildren[_loc8_])
            {
               _loc5_++;
               _loc6_++;
               _loc8_++;
               if(_loc16_ is TableBlockContainer)
               {
                  (_loc16_ as TableBlockContainer).userData.updateCompositionShapes();
               }
            }
            else
            {
               _loc17_ = this._shapeChildren.indexOf(_loc16_);
               if(_loc16_ is TextLine)
               {
                  if(_loc17_ == -1)
                  {
                     this.addTextLine(_loc16_ as TextLine,_loc5_++);
                     _loc6_++;
                  }
                  else
                  {
                     this.removeAndRecycleTextLines(_loc8_,_loc17_);
                     _loc8_ = _loc17_;
                  }
               }
               else if(_loc17_ == -1)
               {
                  this.addTableBlock(_loc16_ as TableBlockContainer,_loc5_++);
                  _loc6_++;
               }
               else
               {
         ...
         if(_loc7_ > 0)
         {
            ...
            this._shapeChildren = this._shapeChildren.concat(_loc4_);
            this._linesInView.length = 0;
         }
         else
         {
      ...
      private function removeAndRecycleTextLines(param1:int, param2:int) : void
      {
         ...
         while(_loc6_ < param2)
         {
            if(!(this._shapeChildren[_loc6_] is TextLine))
            {
               this.removeTableBlock(this._shapeChildren[_loc6_]);
               _loc4_ = null;
            }
            else
            {
         ...
         if(TextLineRecycler.textLineRecyclerEnabled)
         {
            while(param1 < param2)
            {
               if(!(this._shapeChildren[param1] is TextLine))
               {
                  param1++;
               }
               else
      ...
      protected function getFirstTextLineChildIndex() : int
      {
         ...
         while(_loc1_ < this._container.numChildren)
         {
            ...
            if(this._container.getChildAt(_loc1_) is TableBlockContainer)
            {
               break;
            }
            _loc1_++;
      ...
      protected function addTableBlock(param1:TableBlockContainer, param2:int) : void
      {
         if(param2 > this._container.numChildren)
         {
            param2 = this._container.numChildren;
         ...
         this._container.addChildAt(param1,param2);
         param1.userData.updateCompositionShapes();
      }
      
      protected function removeTableBlock(param1:TableBlockContainer) : void
      {
         if(this._container.contains(param1))
         {
            this._container.removeChild(param1);
      ...
      {
         this.writableTextLayoutFormat().borderLeftPriority = param1;
         this.formatChanged();
      }
      ...
      {
         this.writableTextLayoutFormat().borderRightPriority = param1;
         this.formatChanged();
      }
      ...
      {
         this.writableTextLayoutFormat().borderTopPriority = param1;
         this.formatChanged();
      }
      ...
      {
         this.writableTextLayoutFormat().borderBottomPriority = param1;
         this.formatChanged();
      }
      ...
      {
         this.writableTextLayoutFormat().minCellHeight = param1;
         this.formatChanged();
      }
      ...
      {
         this.writableTextLayoutFormat().maxCellHeight = param1;
         this.formatChanged();
      }
      ...
      tlf_internal function testLineVisible(param1:String, param2:int, param3:int, param4:int, param5:int, param6:TextFlowLine, param7:TextLine) : *
      {
         ...
         if(param6 is TextFlowTableBlock)
         {
            if(param6.controller == this)
            {
               return TextFlowTableBlock(param6).container;
            }
            return null;
         }
      ...
      tlf_internal function findCellAtPosition(param1:Point) : CellCoordinates
      {
         var _loc2_:Object = null;
         var _loc3_:TableBlockContainer = null;
         var _loc4_:Vector.<TableCellElement> = null;
         var _loc5_:TableCellElement = null;
         param1 = param1.clone();
         for each(_loc2_ in this._shapeChildren)
         {
            if(_loc2_ is TableBlockContainer)
            {
               _loc3_ = _loc2_ as TableBlockContainer;
               if(_loc3_.y <= param1.y)
               {
                  if(_loc3_.x <= param1.x)
                  {
                     if(_loc3_.y + _loc3_.height >= param1.y)
                     {
                        if(_loc3_.x + _loc3_.getTableWidth() >= param1.x)
                        {
                           param1.x = param1.x - _loc3_.x;
                           param1.y = param1.y - _loc3_.y;
                           _loc4_ = _loc3_.userData.getTableCells();
                           for each(_loc5_ in _loc4_)
                           {
                              if(_loc5_.x + _loc5_.width < param1.x)
                              {
                                 continue;
                              }
                              if(_loc5_.y + _loc5_.getRow().composedHeight < param1.y)
                              {
                                 continue;
                              }
                              ...
                              if(_loc5_.y > param1.y)
                              {
                                 continue;
                              }
                              return new CellCoordinates(_loc5_.rowIndex,_loc5_.colIndex,_loc5_.getTable());
                           }
                        }
                     }
                  }
      ...
      tlf_internal function addComposedTableBlock(param1:TableBlockContainer) : void
      {
         var _loc2_:int = this._tableBlocksInView.indexOf(param1);
         if(_loc2_ >= 0)
         {
            this._tableBlocksInView.splice(_loc2_,1);
         }
         else
         {
            this._tableBlocksInView.push(param1);
         }
      }
      ...
      tlf_internal function get composedLines() : Array
      {
         ...
         var _loc1_:Array = this._linesInView.slice();
         this.intersperseTableBlocks(_loc1_);
         return _loc1_;
      }
      ...
      tlf_internal function clearComposedLines(param1:int) : void
      {
         ...
         var _loc4_:TableBlockContainer = null;
         var _loc5_:TextFlowLine = null;
         var _loc6_:TextFlowTableBlock = null;
         var _loc2_:int = 0;
         for each(_loc3_ in this._linesInView)
         {
            _loc5_ = _loc3_.userData as TextFlowLine;
            if(_loc5_.absoluteStart >= param1)
            {
               break;
            }
            _loc2_++;
         ...
         _loc2_ = 0;
         for each(_loc4_ in this._tableBlocksInView)
         {
            _loc6_ = _loc4_.userData;
            if(_loc4_.userData.absoluteStart >= param1)
            {
               break;
            }
            _loc2_++;
         }
         this._tableBlocksInView.length = _loc2_;
