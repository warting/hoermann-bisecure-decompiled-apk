package flashx.textLayout.elements
{
   ...
   public class FlowElement implements ITextLayoutFormat
   {
      ...
      {
         var _loc1_:TextFlow = this.getTextFlow();
         return _loc1_ && _loc1_.parentElement && _loc1_.parentElement is TableCellElement;
      }
      ...
      public function getParentCellElement() : TableCellElement
      {
         ...
         if(_loc1_.parentElement && _loc1_.parentElement is TableCellElement)
         {
            return _loc1_.parentElement as TableCellElement;
         }
         return null;
      }
