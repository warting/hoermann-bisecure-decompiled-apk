package flashx.textLayout.elements
{
   ...
   public class FlowGroupElement extends FlowElement
   {
      ...
      tlf_internal function getNextLeafHelper(param1:FlowGroupElement, param2:FlowElement) : FlowLeafElement
      {
         ...
         var _loc4_:FlowElement = this.getChildAt(_loc3_ + 1);
      ...
      tlf_internal function createContentAsGroup(param1:int = 0) : GroupElement
      {
         return null;
      }
      ...
      {
         return !(param1 is TextFlow) && !(param1 is FlowLeafElement) && !(param1 is SubParagraphGroupElementBase) && !(param1 is ListItemElement) && !(param1 is TableElement);
      }
            ...
            if(_loc12_)
            {
               ...
               while(_loc11_ < _loc15_)
               {
                  ...
                  if(_loc10_)
                  {
                     ...
                     {
                        throw ArgumentError(GlobalSettings.resourceStringFunction("invalidChildType") + ". " + defaultTypeName + " cannot own " + _loc10_.defaultTypeName);
                     }
                     if(_loc7_ == 0)
                     {
                        _loc9_ = _loc10_;
