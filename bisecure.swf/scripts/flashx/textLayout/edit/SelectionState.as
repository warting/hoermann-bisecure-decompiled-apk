package flashx.textLayout.edit
{
   ...
   public class SelectionState extends TextRange
   {
      ...
      public function SelectionState(param1:TextFlow, param2:int, param3:int, param4:ITextLayoutFormat = null, param5:CellRange = null)
      {
      ...
      public function set cellRange(param1:CellRange) : void
      {
         this._cellRange = param1;
      }
   }
}
