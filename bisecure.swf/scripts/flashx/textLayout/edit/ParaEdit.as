   ...
   public class ParaEdit
   {
      ...
      public static function insertText(param1:TextFlow, param2:int, param3:String, param4:Boolean) : SpanElement
      {
         ...
         else
         {
            ...
            if(_loc5_ is TableLeafElement)
            {
               _loc6_ = _loc5_.parent.parent.getChildIndex(_loc5_.parent) + 1;
            }
            else
            {
         ...
         if(_loc7_.terminatorSpan.textLength == 1 && _loc7_.terminatorSpan == _loc12_)
         {
            param4 = false;
         }
         if(!_loc12_ || param4)
         {
            ...
            if(_loc6_ > 0)
            {
               _loc19_ = _loc9_ - _loc5_.getElementRelativeStart(_loc7_);
               if(param4)
               {
                  if(_loc19_ == 0)
                  {
                  ...
                  else if(_loc19_ != _loc5_.textLength)
                  {
                     _loc5_.splitAtPosition(_loc19_);
                  }
               }
            }
            _loc17_ = _loc7_.findLeaf(_loc9_);
            if(_loc17_ && _loc17_.textLength == 1 && _loc17_.parent == _loc10_ && _loc17_ == _loc7_.terminatorSpan)
            {
               _loc15_ = SpanElement(_loc17_);
            }
            else
            {
               _loc10_.replaceChildren(_loc6_,_loc6_,_loc15_);
            }
            _loc18_ = _loc15_.getPreviousLeaf(_loc7_);
            if(_loc18_ == null)
            {
