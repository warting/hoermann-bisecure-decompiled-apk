package flashx.textLayout.edit
{
   ...
   public class EditManager extends SelectionManager implements IEditManager
   {
      ...
      override public function keyDownHandler(param1:KeyboardEvent) : void
      {
         ...
         var _loc12_:TableCellElement = null;
               ...
               case Keyboard.TAB:
                  if(textFlow.configuration.manageTabKey)
                  {
                     ...
                     else if(textFlow.nestedInTable())
                     {
                        if(param1.shiftKey)
                        {
                           _loc12_ = (textFlow.parentElement as TableCellElement).getPreviousCell();
                        }
                        else
                        {
                           _loc12_ = (textFlow.parentElement as TableCellElement).getNextCell();
                        }
                        if(_loc12_ && _loc12_.textFlow && _loc12_.textFlow.interactionManager is EditManager)
                        {
                           deselect();
                           _loc12_.textFlow.interactionManager.selectAll();
                           _loc12_.textFlow.interactionManager.setFocus();
                        }
                     }
      ...
      public function deleteText(param1:SelectionState = null) : void
      {
         ...
         {
            (subManager as IEditManager).deleteText(param1);
            return;
         }
         param1 = this.defaultOperationState(param1);
         if(!param1)
      ...
      public function deleteNextCharacter(param1:SelectionState = null) : void
      {
         ...
         if(subManager && subManager is IEditManager)
         {
            (subManager as IEditManager).deleteNextCharacter(param1);
            return;
         }
         param1 = this.defaultOperationState(param1);
         if(!param1)
      ...
      public function deleteNextWord(param1:SelectionState = null) : void
      {
         if(subManager && subManager is IEditManager)
         {
            (subManager as IEditManager).deleteNextWord(param1);
            return;
         }
         param1 = this.defaultOperationState(param1);
      ...
      public function deletePreviousCharacter(param1:SelectionState = null) : void
      {
         ...
         if(subManager && subManager is IEditManager)
         {
            (subManager as IEditManager).deletePreviousCharacter(param1);
            return;
         }
         param1 = this.defaultOperationState(param1);
         if(!param1)
      ...
      public function deletePreviousWord(param1:SelectionState = null) : void
      {
         if(subManager && subManager is IEditManager)
         {
            (subManager as IEditManager).deletePreviousWord(param1);
            return;
         }
         param1 = this.defaultOperationState(param1);
         if(!param1)
      ...
      public function insertTableElement(param1:TableElement, param2:SelectionState = null) : void
      {
         if(subManager && subManager is IEditManager)
         {
            (subManager as IEditManager).insertTableElement(param1,param2);
            return;
         }
         param2 = this.defaultOperationState(param2);
         if(!param2)
      ...
      public function insertText(param1:String, param2:SelectionState = null) : void
      {
         ...
         if(subManager && subManager is IEditManager)
         {
            (subManager as IEditManager).insertText(param1,param2);
            return;
         }
      ...
      public function overwriteText(param1:String, param2:SelectionState = null) : void
      {
         if(subManager && subManager is IEditManager)
         {
            (subManager as IEditManager).overwriteText(param1,param2);
            return;
         }
         param2 = this.defaultOperationState(param2);
         if(!param2)
      ...
      public function insertInlineGraphic(param1:Object, param2:Object, param3:Object, param4:Object = null, param5:SelectionState = null) : InlineGraphicElement
      {
         if(subManager && subManager is IEditManager)
         {
            return (subManager as IEditManager).insertInlineGraphic(param1,param2,param3,param4,param5);
         }
      ...
      public function modifyInlineGraphic(param1:Object, param2:Object, param3:Object, param4:Object = null, param5:SelectionState = null) : void
      {
         if(subManager && subManager is IEditManager)
         {
            (subManager as IEditManager).modifyInlineGraphic(param1,param2,param3,param4,param5);
            return;
         }
         param5 = this.defaultOperationState(param5);
         if(!param5)
      ...
      public function applyFormat(param1:ITextLayoutFormat, param2:ITextLayoutFormat, param3:ITextLayoutFormat, param4:SelectionState = null) : void
      {
         if(subManager && subManager is IEditManager)
         {
            (subManager as IEditManager).applyFormat(param1,param2,param3,param4);
            return;
         }
      ...
      public function clearFormat(param1:ITextLayoutFormat, param2:ITextLayoutFormat, param3:ITextLayoutFormat, param4:SelectionState = null) : void
      {
         if(subManager && subManager is IEditManager)
         {
            (subManager as IEditManager).clearFormat(param1,param2,param3,param4);
            return;
         }
         param4 = this.defaultOperationState(param4);
         if(!param4)
      ...
      public function applyLeafFormat(param1:ITextLayoutFormat, param2:SelectionState = null) : void
      {
         if(subManager && subManager is IEditManager)
         {
            (subManager as IEditManager).applyLeafFormat(param1,param2);
         }
         else
         {
      ...
      public function applyParagraphFormat(param1:ITextLayoutFormat, param2:SelectionState = null) : void
      {
         if(subManager && subManager is IEditManager)
         {
            (subManager as IEditManager).applyParagraphFormat(param1,param2);
         }
         else
         {
      ...
      public function applyContainerFormat(param1:ITextLayoutFormat, param2:SelectionState = null) : void
      {
         if(subManager && subManager is IEditManager)
         {
            (subManager as IEditManager).applyContainerFormat(param1,param2);
         }
         else
         {
      ...
      public function cutTextScrap(param1:SelectionState = null) : TextScrap
      {
         if(subManager && subManager is IEditManager)
         {
            return (subManager as IEditManager).cutTextScrap(param1);
         }
         param1 = this.defaultOperationState(param1);
         if(!param1)
         {
      ...
      public function pasteTextScrap(param1:TextScrap, param2:SelectionState = null) : void
      {
         if(subManager && subManager is IEditManager)
         {
            (subManager as IEditManager).pasteTextScrap(param1,param2);
            return;
         }
         param2 = this.defaultOperationState(param2);
         if(!param2)
      ...
      public function applyTCY(param1:Boolean, param2:SelectionState = null) : TCYElement
      {
         if(subManager && subManager is IEditManager)
         {
            return (subManager as IEditManager).applyTCY(param1,param2);
         }
         param2 = this.defaultOperationState(param2);
         if(!param2)
         {
