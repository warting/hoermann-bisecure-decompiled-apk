package com.isisic.remote.lw
{
   ...
   public class Debug
   {
      ...
      public static var TRACE_INPUT:Boolean = true;
      
      public static var TRACE_OUTPUT:Boolean = true;
      ...
      public static function inPackage(param1:MCP, param2:String = null, param3:String = null, param4:String = null) : Boolean
      {
         if(TRACE_INPUT)
         {
      ...
      public static function outPackage(param1:MCP, param2:String = null, param3:String = null, param4:String = null) : Boolean
      {
         if(TRACE_OUTPUT)
         {
      ...
      private static function writeMCP(param1:String, param2:MCP, param3:String, param4:String = null, param5:String = null, param6:String = null) : void
      {
         var _loc9_:int = 0;
         ...
         if(param2.payload)
         {
            ...
            {
               _loc14_ = param2.payload.readUnsignedByte().toString(16).toUpperCase();
               _loc13_ = _loc13_ + ("0x" + (_loc14_.length < 2?"0" + _loc14_:_loc14_) + " ");
            }
            param2.payload.position = 0;
      ...
      public static function netDebug_connect() : void
      {
         ...
         if(dbgCfg && dbgCfg.host != null && dbgCfg.host != "" && dbgCfg.port > 0)
         {
            socketConnect = function(param1:Event):void
            {
               ...
               Debug.info("[Log] netDebug connected");
            };
