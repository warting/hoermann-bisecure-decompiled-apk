package com.isisic.remote.lw.net
{
   ...
   public class HTTPClient extends EventDispatcher implements IClient
   {
      ...
      public var idleTimeout:int = 8.64E7;
      ...
      protected var _httpAutentication:URLRequestHeader = null;
      ...
      public function set httpAutentication(param1:URLRequestHeader) : void
      {
         this._httpAutentication = param1;
         this.sendAuth = true;
      }
      
      public function get httpAutentication() : URLRequestHeader
      {
         return this._httpAutentication;
      }
      ...
      protected function onData(param1:Event) : void
      {
         ...
         if(!this.receiveTMCP)
         {
            ...
            dispatchEvent(new RawDataEvent(RawDataEvent.DATA,false,false,_loc3_));
            return;
         }
         ...
         while(_loc2_.length >= MCP.ADDRESS_SIZE * 2 + MCP.FRAME_SIZE + 2)
         {
            ...
            {
               Debug.error("[HttpClient] invalid tmcp Package:\n" + _loc5_ + "\n" + _loc6_ + "\n" + _loc2_);
               break;
            }
         ...
         if(!_loc4_)
         {
            Debug.warning("[HttpClient] Empty response!");
            dispatchEvent(new RawDataEvent(RawDataEvent.NO_DATA));
            return;
         }
      }
      ...
      protected function onStatusResponse(param1:HTTPStatusEvent) : void
      {
         ...
         Debug.debug("[HTTPClient] Response State: " + param1.status);
         dispatchEvent(param1);
      }
      
      protected function onError(param1:IOErrorEvent) : void
      {
         Debug.error("[HttpClient] IOERROR! " + param1);
      ...
      {
         Debug.error("[HttpClient] SecError! " + param1);
      ...
      public function send(param1:ByteArray) : void
      {
         ...
         {
            Debug.error("Class HttpClient expects data to be an Bytearray!");
            return;
         }
         param1.position = 0;
      ...
      public function sendVars(param1:URLVariables) : void
      {
         ...
         if(this.httpAutentication)
         {
            _loc3_.requestHeaders.push(this.httpAutentication);
            this.sendAuth = false;
         }
         _loc2_.load(_loc3_);
      }
