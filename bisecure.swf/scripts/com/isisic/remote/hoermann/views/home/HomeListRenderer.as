package com.isisic.remote.hoermann.views.home
{
   ...
   public class HomeListRenderer extends RoundetTableItemRenderer
   {
       
      
      public var lblTitle:Label;
      
      public function HomeListRenderer()
      {
         super();
      }
      ...
      override protected function layoutComponents(param1:Number, param2:Number) : void
      {
         ...
         this.lblTitle.maxWidth = param1 - marginLeft - marginRight - borderRadius * 2;
      }
