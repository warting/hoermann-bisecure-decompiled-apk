package com.isisic.remote.hoermann.views.options.settings
{
   ...
   import com.isisic.remote.hoermann.components.overlays.screens.ManagePopupsScreenOverlay;
   ...
   public class ManagePopups extends View implements IBindingClient
   {
      ...
      public function ManagePopups()
      {
         ...
         {
            watcherSetupUtilClass = getDefinitionByName("_com_isisic_remote_hoermann_views_options_settings_ManagePopupsWatcherSetupUtil");
         ...
         this.addEventListener("creationComplete",this.___ManagePopups_View1_creationComplete);
         var i:uint = 0;
      ...
      {
         this.chkInfos.selected = HoermannRemote.appData.isGateNotResponsableSuppressed;
         this.chkWarnings.selected = HoermannRemote.appData.isGateOutOfViewSuppressed;
         this.bbar.addEventListener(BottomBarEvent.HELP,function(param1:Event):void
         {
            new ManagePopupsScreenOverlay(chkInfos,chkWarnings,btnSubmit,btnCancel,bbar.callout).open(null);
         });
      }
      ...
      {
         HoermannRemote.appData.isGateNotResponsableSuppressed = this.chkInfos.selected;
         HoermannRemote.appData.isGateOutOfViewSuppressed = this.chkWarnings.selected;
      ...
      public function ___ManagePopups_View1_creationComplete(param1:FlexEvent) : void
      {
         this.onComplete();
      }
