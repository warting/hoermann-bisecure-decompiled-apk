package com.isisic.remote.hoermann.views.options.settings
{
   ...
   import com.isisic.remote.hoermann.components.overlays.screens.ChangePasswordScreenOverlay;
   ...
   public class ChangePasswordScreen extends View implements IBindingClient
   {
      ...
      public function ChangePasswordScreen()
      {
         ...
         {
            watcherSetupUtilClass = getDefinitionByName("_com_isisic_remote_hoermann_views_options_settings_ChangePasswordScreenWatcherSetupUtil");
         ...
         this.addEventListener("creationComplete",this.___ChangePasswordScreen_View1_creationComplete);
         var i:uint = 0;
      ...
      {
         this.username.text = HoermannRemote.appData.username;
         this.bbar.addEventListener(BottomBarEvent.HELP,function(param1:Event):void
         {
            new ChangePasswordScreenOverlay(username,newPasswd,retype,btnSubmit,btnCancel,bbar.callout).open(null);
         });
      }
      ...
      private function onSubmit(param1:MouseEvent) : void
      {
         ...
         },loaderFailed = function(param1:Event):void
         {
            ...
            Debug.warning("[ChangePasswordScreen] Requesting a password change failed!\n" + param1);
            Logicware.finalizeMCPLoader(loader,loaderComplete,loaderFailed);
         });
      ...
      public function ___ChangePasswordScreen_View1_creationComplete(param1:FlexEvent) : void
      {
         this.onComplete();
      }
