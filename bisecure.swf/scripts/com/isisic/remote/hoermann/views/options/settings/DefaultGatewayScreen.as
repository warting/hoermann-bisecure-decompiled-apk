package com.isisic.remote.hoermann.views.options.settings
{
   ...
   import com.isisic.remote.hoermann.components.overlays.screens.DefaultGatewayScreenOverlay;
   ...
   public class DefaultGatewayScreen extends View implements IBindingClient
   {
      ...
      public function DefaultGatewayScreen()
      {
         ...
         {
            watcherSetupUtilClass = getDefinitionByName("_com_isisic_remote_hoermann_views_options_settings_DefaultGatewayScreenWatcherSetupUtil");
         ...
         this.addEventListener("creationComplete",this.___DefaultGatewayScreen_View1_creationComplete);
      ...
      private function onInit() : void
      {
         ...
         {
            new DefaultGatewayScreenOverlay(chkDefault,btnSubmit,btnCancel,bbar.callout).open(null);
         });
      }
      ...
      private function onSubmit(param1:MouseEvent) : void
      {
         ...
         if(this.chkDefault.selected)
         {
            ...
            _loc2_ = HoermannRemote.appData;
            HoermannRemote.appData.autoLogin = HoermannRemote.appData.activeLogin;
         }
         else
         {
      ...
      private function get isDefault() : Boolean
      {
         ...
         {
            if(HoermannRemote.appData.autoLogin.mac == HoermannRemote.appData.activeGateway.mac)
            {
               return true;
            }
         }
      ...
      public function ___DefaultGatewayScreen_View1_creationComplete(param1:FlexEvent) : void
      {
         this.onComplete();
      }
