package com.isisic.remote.hoermann.views.scenarios
{
   ...
   public class ScenarioRenderer extends RoundetTableItemRenderer implements IBindingClient
   {
      ...
      public function ScenarioRenderer()
      {
         ...
         {
            watcherSetupUtilClass = getDefinitionByName("_com_isisic_remote_hoermann_views_scenarios_ScenarioRendererWatcherSetupUtil");
      ...
      {
         dispatchEvent(new ScenarioEvent(ScenarioEvent.EDIT));
      }
