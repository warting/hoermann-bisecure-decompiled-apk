package com.isisic.remote.hoermann.net
{
   ...
   public class HmTransition
   {
      ...
      var ignoreRetries:Boolean = false;
      ...
      public function toString() : String
      {
         ...
         return "soll: 0x" + StringHelper.fillWith(this.actual.toString(16),"0") + " " + "ist: 0x" + StringHelper.fillWith(this.desired.toString(16),"0") + " " + "zeit: 0d" + StringHelper.fillWith(this.driveTime.toString(10),"0") + " " + "gk: 0x" + StringHelper.fillWith(this.gk.toString(16),"0",4) + " " + "hcp: " + this.hcp + "exst: " + _loc1_ + "error: " + this.error + " autoClose: " + this.autoClose;
      }
   }
}
