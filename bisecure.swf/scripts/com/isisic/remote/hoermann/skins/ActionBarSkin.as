package com.isisic.remote.hoermann.skins
{
   ...
   import me.mweber.basic.ScreenSizes;
   ...
   public class ActionBarSkin extends MobileSkin
   {
      ...
      public var titleDisplay:TitleDisplayComponent#462;
      ...
      public function ActionBarSkin()
      {
         ...
         switch(MultiDevice.screenSize)
         {
            case ScreenSizes.XXLARGE:
               this.layoutContentGroupHeight = 178;
      ...
      override protected function createChildren() : void
      {
         ...
         this.titleDisplay = new TitleDisplayComponent#462();
...
class TitleDisplayComponent#462 extends UIComponent implements IDisplayText
{
   ...
   function TitleDisplayComponent#462()
   {
      super();
      this.title = "";
   }
   ...
   override protected function updateDisplayList(param1:Number, param2:Number) : void
   {
      ...
      this.titleDisplayShadow.setLayoutBoundsPosition(2,_loc4_ + 2);
