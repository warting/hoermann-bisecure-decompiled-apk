package com.isisic.remote.hoermann.global.stateHelper.implementation
{
   ...
   public class Smartkey_StateHelper extends StateHelperBase
   {
      ...
      {
         var _loc4_:SmartkeyInfos = this.getStateInfos(param2,param3);
         Debug.debug("[Smartkey_StateHelper] getStateLabelRequested: \n" + _loc4_.stateLabel + "\n" + param2.toString());
      ...
      private function getStateInfos(param1:HmTransition, param2:Boolean) : SmartkeyInfos#183
      {
         var _loc3_:SmartkeyInfos = new SmartkeyInfos#183();
         ...
         switch(_loc4_)
         {
            case SmartkeyStates#183.UNBEKANNT:
               _loc3_.showState = false;
               ...
               _loc3_.stateValue = "";
               break;
            case SmartkeyStates#183.GEOEFFNET:
               ...
               _loc3_.stateValue = "";
               break;
            case SmartkeyStates#183.ENTRIEGELT:
               _loc3_.additionalStateImage = new Fxg_Unlocked();
               _loc3_.state = ActorState.CLOSED;
               _loc3_.stateLabel = Lang.getString("DRIVE_MESSAGE_UNLOCKED");
               _loc3_.stateValue = "";
               break;
            case SmartkeyStates#183.VERRIEGELT_1:
            case SmartkeyStates#183.VERRIEGELT_2:
            case SmartkeyStates#183.VERRIEGELT_3:
               _loc3_.additionalStateImage = new Fxg_Locked();
               _loc3_.state = ActorState.CLOSED;
               _loc3_.stateLabel = Lang.getString("DRIVE_MESSAGE_LOCKED");
               _loc3_.stateValue = "";
               break;
            case SmartkeyStates#183.FAHREND_R_GEOEFFNET:
            case SmartkeyStates#183.FAHREND_R_ENTRIEGELT:
            case SmartkeyStates#183.FAHREND_R_VERRIEGELT_1:
            case SmartkeyStates#183.FAHREND_R_VERRIEGELT_2:
            case SmartkeyStates#183.FAHREND_R_VERRIEGELT_3:
               _loc3_.additionalStateImage = null;
               _loc3_.state = null;
               _loc3_.stateLabel = null;
               _loc3_.stateValue = null;
         }
         if(_loc6_ != SmartkeyBatteryStates#183.BATTERY_OK)
         {
...
class SmartkeyInfos#183
{
   ...
   function SmartkeyInfos#183()
   {
      super();
   }
}

class SmartkeyStates#183
{
   ...
   function SmartkeyStates#183()
   {
      super();
   }
}

class SmartkeyBatteryStates#183
{
   ...
   function SmartkeyBatteryStates#183()
   {
      super();
   }
}
