package com.isisic.remote.hoermann.global.stateHelper.implementation
{
   ...
   public class HET_E2_SL_StateHelper extends StateHelperBase
   {
      ...
      override public function forceState(param1:HmTransition, param2:Boolean) : String
      {
         ...
         var _loc3_:PinParser = new PinParser#2918(param1);
         switch(_loc3_.pinDefinition)
         {
            case PinParser#2918.P1_LOW_P3_HIGH:
               return ActorState.EXTENDED;
            case PinParser#2918.P1_HIGH_P3_LOW:
               return ActorState.RETRACTED;
            case PinParser#2918.P1_HIGH_P3_HIGH:
               return ActorState.NOT_RETRACTED;
            case PinParser#2918.P1_LOW_P3_LOW:
               return ActorState.EXTENDED;
            default:
               return null;
         }
      ...
      override public function getStateLabel(param1:Object, param2:HmTransition, param3:Boolean) : String
      {
         ...
         var _loc4_:PinParser = new PinParser#2918(param2);
...
class PinParser#2918
{
   ...
   function PinParser#2918(param1:HmTransition)
   {
      super();
