package com.isisic.remote.hoermann.components.stateImages
{
   ...
   public class SwingGateDoubleStateImage extends StateImageBase implements IBindingClient
   {
      ...
      public function SwingGateDoubleStateImage()
      {
         ...
         {
            watcherSetupUtilClass = getDefinitionByName("_com_isisic_remote_hoermann_components_stateImages_SwingGateDoubleStateImageWatcherSetupUtil");
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         if(this._additionalIcon != null && this._secondAdditionalIcon == null)
         {
            ...
            Debug.debug("[SwingGateDoubleStateImage] stateHeight = " + stateHeight + "\n\t\tstateContainer.height = " + this.stateContainer.height);
