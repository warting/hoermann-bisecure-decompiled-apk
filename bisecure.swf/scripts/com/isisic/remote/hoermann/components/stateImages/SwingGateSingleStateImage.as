package com.isisic.remote.hoermann.components.stateImages
{
   ...
   import com.isisic.remote.hoermann.assets.images.devices.swingGateSingle.Fxg_SGS_StateClosed;
   import com.isisic.remote.hoermann.assets.images.devices.swingGateSingle.Fxg_SGS_StateHalf1;
   import com.isisic.remote.hoermann.assets.images.devices.swingGateSingle.Fxg_SGS_StateHalf2;
   import com.isisic.remote.hoermann.assets.images.devices.swingGateSingle.Fxg_SGS_StateHalf3;
   ...
   import com.isisic.remote.hoermann.skins.stateImageSkins.GateStateImageSkin;
   ...
   public class SwingGateSingleStateImage extends StateImageBase implements IBindingClient
   {
      ...
      public function SwingGateSingleStateImage()
      {
         ...
         var bindings:Array = this._SwingGateSingleStateImage_bindingsSetup();
         var watchers:Array = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_com_isisic_remote_hoermann_components_stateImages_SwingGateSingleStateImageWatcherSetupUtil");
         ...
         {
            return SwingGateSingleStateImage[param1];
         },bindings,watchers);
         mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
         mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
         this.mxmlContentFactory = new DeferredInstanceFromFunction(this._SwingGateSingleStateImage_Array1_c);
         var i:uint = 0;
      ...
      {
         SwingGateSingleStateImage._watcherSetupUtil = param1;
      }
         ...
         if(param1.transition != null && param1.additionalIcon is BusyIndicator)
         {
            if(HmTransitionHelper.isDriving(param1.transition))
            {
               ...
               if(HmTransitionHelper.isDrivingToClose(param1.transition))
               {
                  ...
                  (_loc2_.animation as MoveRightAnimation).paddingLeft = 30;
                  (_loc2_.animation as MoveRightAnimation).paddingRight = 30;
               ...
               else if(HmTransitionHelper.isDrivingToOpen(param1.transition))
               {
                  ...
                  (_loc2_.animation as MoveLeftAnimation).paddingLeft = 30;
                  (_loc2_.animation as MoveLeftAnimation).paddingRight = 30;
         ...
         if(param1.showState && param1.requestable)
         {
            switch(param1.actorState)
            {
               case ActorState.CLOSED:
                  this.setStateImage(new Fxg_SGS_StateClosed(),param1.additionalIcon);
                  break;
               case ActorState.HALF_3:
                  this.setStateImage(new Fxg_SGS_StateHalf3(),param1.additionalIcon);
                  break;
               case ActorState.HALF_2:
                  this.setStateImage(new Fxg_SGS_StateHalf2(),param1.additionalIcon);
                  break;
               case ActorState.HALF_1:
                  this.setStateImage(new Fxg_SGS_StateHalf1(),param1.additionalIcon);
                  break;
               ...
               default:
                  ...
                  Debug.error("[SwingGateSingleStateImage] ActorState \'" + param1.actorState + "\' is not available for SwingGateSingleStateImage!");
            }
         }
      ...
      private function _SwingGateSingleStateImage_Array1_c() : Array
      {
         var _loc1_:Array = [this._SwingGateSingleStateImage_Group1_i()];
         return _loc1_;
      }
      
      private function _SwingGateSingleStateImage_Group1_i() : Group
      {
      ...
      private function _SwingGateSingleStateImage_bindingsSetup() : Array
      {
         var result:Array = [];
