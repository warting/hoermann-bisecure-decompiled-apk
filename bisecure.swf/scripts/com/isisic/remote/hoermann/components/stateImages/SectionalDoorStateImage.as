package com.isisic.remote.hoermann.components.stateImages
{
   ...
   import com.isisic.remote.hoermann.assets.images.devices.sectionalDoor.FxgStateClosed;
   import com.isisic.remote.hoermann.assets.images.devices.sectionalDoor.FxgStateHalf1;
   import com.isisic.remote.hoermann.assets.images.devices.sectionalDoor.FxgStateHalf2;
   import com.isisic.remote.hoermann.assets.images.devices.sectionalDoor.FxgStateHalf3;
   import com.isisic.remote.hoermann.assets.images.devices.sectionalDoor.FxgStateOpened;
   ...
   import com.isisic.remote.hoermann.components.busyIndicator.animations.MoveDownAnimation;
   ...
   public class SectionalDoorStateImage extends StateImageBase implements IBindingClient
   {
      ...
      public function SectionalDoorStateImage()
      {
         ...
         var bindings:Array = this._SectionalDoorStateImage_bindingsSetup();
         var watchers:Array = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_com_isisic_remote_hoermann_components_stateImages_SectionalDoorStateImageWatcherSetupUtil");
         ...
         {
            return SectionalDoorStateImage[param1];
         },bindings,watchers);
         mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
         mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
         this.mxmlContentFactory = new DeferredInstanceFromFunction(this._SectionalDoorStateImage_Array1_c);
         var i:uint = 0;
      ...
      {
         SectionalDoorStateImage._watcherSetupUtil = param1;
      }
         ...
         if(param1.showState && param1.requestable)
         {
            switch(param1.actorState)
            {
               case ActorState.CLOSED:
                  this.setStateImage(new FxgStateClosed(),param1.additionalIcon);
                  break;
               case ActorState.HALF_3:
                  this.setStateImage(new FxgStateHalf3(),param1.additionalIcon);
                  break;
               case ActorState.HALF_2:
                  this.setStateImage(new FxgStateHalf2(),param1.additionalIcon);
                  break;
               case ActorState.HALF_1:
                  this.setStateImage(new FxgStateHalf1(),param1.additionalIcon);
                  break;
               case ActorState.OPEN:
                  this.setStateImage(new FxgStateOpened(),param1.additionalIcon);
                  break;
               default:
                  this.setStateImage(null,new FxgUnavailable());
                  Debug.error("[SectionalDoorStateImage] ActorState \'" + param1.actorState + "\' is not available for SectionalDoorStateImage!");
            }
         }
      ...
      private function _SectionalDoorStateImage_Array1_c() : Array
      {
         var _loc1_:Array = [this._SectionalDoorStateImage_Group1_i()];
         return _loc1_;
      }
      
      private function _SectionalDoorStateImage_Group1_i() : Group
      {
      ...
      private function _SectionalDoorStateImage_bindingsSetup() : Array
      {
         var result:Array = [];
