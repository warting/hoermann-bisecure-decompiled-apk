...
{
   import com.isisic.remote.hoermann.assets.images.devices.door.Fxg_D_StateClosed;
   import com.isisic.remote.hoermann.assets.images.devices.door.Fxg_D_StateHalf1;
   import com.isisic.remote.hoermann.assets.images.devices.door.Fxg_D_StateHalf2;
   import com.isisic.remote.hoermann.assets.images.devices.door.Fxg_D_StateHalf3;
   import com.isisic.remote.hoermann.assets.images.devices.door.Fxg_D_StateOpened;
   ...
   import com.isisic.remote.hoermann.skins.stateImageSkins.DoorStateImageSkin;
   ...
   public class DoorStateImage extends StateImageBase implements IBindingClient
   {
      
      private static var _watcherSetupUtil:IWatcherSetupUtil2;
       
      
      private var _1858319682debugLayer:Graphic;
      ...
      public function DoorStateImage()
      {
         ...
         var bindings:Array = this._DoorStateImage_bindingsSetup();
         var watchers:Array = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_com_isisic_remote_hoermann_components_stateImages_DoorStateImageWatcherSetupUtil");
         ...
         {
            return DoorStateImage[param1];
         },bindings,watchers);
         mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
         mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
         this.mxmlContentFactory = new DeferredInstanceFromFunction(this._DoorStateImage_Array1_c);
         var i:uint = 0;
      ...
      {
         DoorStateImage._watcherSetupUtil = param1;
      }
      ...
      override public function set moduleFactory(param1:IFlexModuleFactory) : void
      {
         ...
         {
            this.skinClass = DoorStateImageSkin;
         };
      }
         ...
         if(param1.showState && param1.requestable)
         {
            switch(param1.actorState)
            {
               case ActorState.CLOSED:
                  this.setStateImage(new Fxg_D_StateClosed(),param1.additionalIcon);
                  break;
               case ActorState.HALF_3:
                  this.setStateImage(new Fxg_D_StateHalf3(),param1.additionalIcon);
                  break;
               case ActorState.HALF_2:
                  this.setStateImage(new Fxg_D_StateHalf2(),param1.additionalIcon);
                  break;
               case ActorState.HALF_1:
                  this.setStateImage(new Fxg_D_StateHalf1(),param1.additionalIcon);
                  break;
               case ActorState.OPEN:
                  this.setStateImage(new Fxg_D_StateOpened(),param1.additionalIcon);
            }
         }
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         if(this._additionalIcon != null)
         {
            ...
            this._additionalIcon.width = this.stateContainer.width * (_loc3_ / 100);
            this._additionalIcon.height = this._additionalIcon.width * (_loc4_.y / _loc4_.x);
      ...
      private function _DoorStateImage_Array1_c() : Array
      {
         var _loc1_:Array = [this._DoorStateImage_Group1_i(),this._DoorStateImage_Graphic1_i()];
         return _loc1_;
      }
      
      private function _DoorStateImage_Group1_i() : Group
      {
      ...
      private function _DoorStateImage_Graphic1_i() : Graphic
      {
         var _loc1_:Graphic = new Graphic();
         _loc1_.percentWidth = 100;
         _loc1_.percentHeight = 100;
         _loc1_.id = "debugLayer";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
         this.debugLayer = _loc1_;
         BindingManager.executeBindings(this,"debugLayer",this.debugLayer);
         return _loc1_;
      }
      
      private function _DoorStateImage_bindingsSetup() : Array
      {
         var result:Array = [];
         ...
         {
            return stateHeight * (80 / 126);
         },null,"stateContainer.width");
         result[3] = new Binding(this,function():Number
         {
            return width - stateContainer.width - (imageRectPaddingRight + outlineThickness * 2);
      ...
      public function get debugLayer() : Graphic
      {
         return this._1858319682debugLayer;
      }
      
      public function set debugLayer(param1:Graphic) : void
      {
         var _loc2_:Object = this._1858319682debugLayer;
         if(_loc2_ !== param1)
         {
            this._1858319682debugLayer = param1;
            if(this.hasEventListener("propertyChange"))
            {
               this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this,"debugLayer",_loc2_,param1));
            }
         }
      }
