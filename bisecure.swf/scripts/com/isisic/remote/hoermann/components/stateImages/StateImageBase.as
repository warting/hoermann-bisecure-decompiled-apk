package com.isisic.remote.hoermann.components.stateImages
{
   ...
   public class StateImageBase extends SkinnableContainer implements IDisposable
   {
      ...
      private static function getWhiteWeel() : IVisualElement
      {
      ...
      public function set transition(param1:HmTransition) : void
      {
         ...
         _loc2_.requestable = _loc3_.requestablePorts != null && _loc3_.requestablePorts[this.groupId] != null && _loc3_.requestablePorts[this.groupId] < 255;
         ...
         switch(true)
         {
            ...
            case param1 == null && _loc2_.requestable:
               ...
               {
                  _loc2_.additionalIcon = getWhiteWeel();
               }
               else
               {
