package com.isisic.remote.hoermann.components.stateImages
{
   ...
   import com.isisic.remote.hoermann.assets.images.devices.jack.Fxg_J_StateOff;
   import com.isisic.remote.hoermann.assets.images.devices.jack.Fxg_J_StateOn;
   import com.isisic.remote.hoermann.global.stateHelper.ActorState;
   import com.isisic.remote.hoermann.skins.stateImageSkins.JackStateImageSkin;
   ...
   public class JackStateImage extends StateImageBase implements IBindingClient
   {
      ...
      public function JackStateImage()
      {
         ...
         var bindings:Array = this._JackStateImage_bindingsSetup();
         var watchers:Array = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_com_isisic_remote_hoermann_components_stateImages_JackStateImageWatcherSetupUtil");
         ...
         {
            return JackStateImage[param1];
         },bindings,watchers);
         mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
         mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
         this.mxmlContentFactory = new DeferredInstanceFromFunction(this._JackStateImage_Array1_c);
         var i:uint = 0;
      ...
      {
         JackStateImage._watcherSetupUtil = param1;
      }
      ...
      override public function set moduleFactory(param1:IFlexModuleFactory) : void
      {
         ...
         {
            this.skinClass = JackStateImageSkin;
         };
      }
      ...
      override protected function updateState(param1:StateUpdateProperties) : void
      {
         ...
         if(param1.showState && param1.requestable)
         {
            ...
            {
               case ActorState.ON:
                  this.setStateImage(new Fxg_J_StateOn(),param1.additionalIcon);
                  break;
               case ActorState.OFF:
                  this.setStateImage(new Fxg_J_StateOff(),param1.additionalIcon);
                  break;
               default:
                  this.setStateImage(null,new FxgUnavailable());
                  Debug.error("[JackStateImage] ActorState \'" + param1.actorState + "\' is not available for JackStateImage!");
            }
         }
      ...
      private function _JackStateImage_Array1_c() : Array
      {
         var _loc1_:Array = [this._JackStateImage_Group1_i()];
         return _loc1_;
      }
      
      private function _JackStateImage_Group1_i() : Group
      {
      ...
      private function _JackStateImage_bindingsSetup() : Array
      {
         var result:Array = [];
