package com.isisic.remote.hoermann.components.stateImages
{
   ...
   import com.isisic.remote.hoermann.assets.images.devices.horizontalSectionalDoor.FxgStateClosed;
   import com.isisic.remote.hoermann.assets.images.devices.horizontalSectionalDoor.FxgStateHalf1;
   import com.isisic.remote.hoermann.assets.images.devices.horizontalSectionalDoor.FxgStateHalf2;
   import com.isisic.remote.hoermann.assets.images.devices.horizontalSectionalDoor.FxgStateHalf3;
   import com.isisic.remote.hoermann.assets.images.devices.horizontalSectionalDoor.FxgStateOpened;
   ...
   public class HorizontalSectionalDoorStateImage extends StateImageBase implements IBindingClient
   {
      ...
      public function HorizontalSectionalDoorStateImage()
      {
         ...
         var bindings:Array = this._HorizontalSectionalDoorStateImage_bindingsSetup();
         var watchers:Array = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_com_isisic_remote_hoermann_components_stateImages_HorizontalSectionalDoorStateImageWatcherSetupUtil");
         ...
         {
            return HorizontalSectionalDoorStateImage[param1];
         },bindings,watchers);
         mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
         mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
         this.mxmlContentFactory = new DeferredInstanceFromFunction(this._HorizontalSectionalDoorStateImage_Array1_c);
         var i:uint = 0;
      ...
      {
         HorizontalSectionalDoorStateImage._watcherSetupUtil = param1;
      }
         ...
         if(param1.showState && param1.requestable)
         {
            switch(param1.actorState)
            {
               ...
               default:
                  ...
                  Debug.error("[HorizontalSectionalDoorStateImage] ActorState \'" + param1.actorState + "\' is not available for HorizontalSectionalDoorStateImage!");
            }
         }
      ...
      private function _HorizontalSectionalDoorStateImage_Array1_c() : Array
      {
         var _loc1_:Array = [this._HorizontalSectionalDoorStateImage_Group1_i()];
         return _loc1_;
      }
      
      private function _HorizontalSectionalDoorStateImage_Group1_i() : Group
      {
      ...
      private function _HorizontalSectionalDoorStateImage_bindingsSetup() : Array
      {
         var result:Array = [];
