package com.isisic.remote.hoermann.components.stateImages
{
   ...
   public class SlidingGateStateImage extends StateImageBase implements IBindingClient
   {
      ...
      public function SlidingGateStateImage()
      {
         ...
         {
            watcherSetupUtilClass = getDefinitionByName("_com_isisic_remote_hoermann_components_stateImages_SlidingGateStateImageWatcherSetupUtil");
         ...
         if(param1.showState && param1.requestable)
         {
            switch(param1.actorState)
            {
               ...
               default:
                  ...
                  Debug.error("[SlidingGateStateImage] ActorState \'" + param1.actorState + "\' is not available for SlidingGateStateImage!");
            }
         }
