package com.isisic.remote.hoermann.components.overlays.screens
{
   ...
   public class ScenarioScreenOverlay extends AutoDrawOverlay
   {
      ...
      public function ScenarioScreenOverlay(param1:IVisualElement, param2:IVisualElement, param3:IVisualElement, param4:IVisualElement)
      {
         super();
         this.back = param1;
         this.add = param2;
      ...
      override protected function createChildren() : void
      {
         ...
         this.backDesc.text = Lang.getString("DESC_SCENARIOS_BACK");
         ...
         this.addDesc.text = Lang.getString("DESC_SCENARIOS_ADD");
         ...
         this.editDesc.text = Lang.getString("DESC_SCENARIOS_EDIT");
