package com.isisic.remote.hoermann.components.popups
{
   ...
   import com.isisic.remote.hoermann.global.valueObjects.localStorage.ScenarioAction;
   ...
   public class AddScenarioBox extends Popup
   {
      ...
      public function AddScenarioBox(param1:Array, param2:Object = null)
      {
         super();
         this.editMode = true;
         if(!param2)
      ...
      private function labelActionList(param1:Object) : String
      {
         ...
         return _loc3_.name + " - " + Lang.getString("CHANNEL_" + PortTypes.NAMES[param1.portType]);
      }
      ...
      private function onAddClick(param1:MouseEvent) : void
      {
         ...
         this.activeAction = new ScenarioAction(-1,-1,-1);
      ...
      protected function onSelectChannelComplete(param1:PopUpEvent) : void
      {
         ...
         this.activeAction.portId = param1.data.id;
         this.activeAction.portType = param1.data.type;
