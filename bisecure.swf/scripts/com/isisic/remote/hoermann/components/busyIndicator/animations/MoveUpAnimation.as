package com.isisic.remote.hoermann.components.busyIndicator.animations
{
   ...
   public class MoveUpAnimation implements IAnimation
   {
      ...
      public function MoveUpAnimation()
      {
         super();
      }
      ...
      {
         return new Point((param2.width - param1.width) / 2,param2.height + this.paddingBottom);
      }
      ...
      public function getEffect(param1:IVisualElement, param2:IVisualElement) : Effect
      {
         ...
         _loc4_.xTo = _loc3_.x;
         _loc4_.yTo = param1.height * -1 - this.paddingTop;
         return _loc4_;
      }
   }
}
