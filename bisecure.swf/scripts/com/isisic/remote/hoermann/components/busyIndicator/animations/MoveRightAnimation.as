package com.isisic.remote.hoermann.components.busyIndicator.animations
{
   ...
   public class MoveRightAnimation implements IAnimation
   {
      ...
      public function MoveRightAnimation()
      {
         super();
      }
      ...
      {
         return new Point(param1.width * -1 - this.paddingLeft,(param2.height - param1.height) / 2);
      }
      ...
      public function getEffect(param1:IVisualElement, param2:IVisualElement) : Effect
      {
         ...
         _loc4_.xTo = param2.width + this.paddingRight;
         _loc4_.yTo = _loc3_.y;
         return _loc4_;
      }
   }
